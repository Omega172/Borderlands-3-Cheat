...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ON5N[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		float                                                      ShieldPercentRemaining;                                  // 0x0000(0x0004)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_DFHU[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_U8MW[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct ABPChar_Operative_C_GetSkeletalMeshHead_Params
	{
	public:
		class UGbxSkeletalMeshComponent*                           HeadMesh;                                                // 0x0000(0x0008)  (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};

	/**
	 * Function BPChar_Operative.BPChar_Operative_C.Get Skeletal Mesh Arms
	 */
	struct ABPChar_Operative_C_GetSkeletalMeshArms_Params
	{
	public:
		class USkeletalMeshComponent*                              ArmsMesh;                                                // 0x0000(0x0008)  (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};

	/**
	 * Function BPChar_Operative.BPChar_Operative_C.Get Skeletal Mesh Legs
	 */
	struct ABPChar_Operative_C_GetSkeletalMeshLegs_Params
	{
	public:
	 ...
	 */
	struct ABPChar_Operative_C_GetSkeletalMesh_Params
	{
	public:
	 ...
	 */
	struct ABPChar_Operative_C_GetMaterialsHead_Params
	{
	public:
	 ...
	 */
	struct ABPChar_Operative_C_GetMaterialsArms_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
	 ...
	 */
	struct ABPChar_Operative_C_GetMaterialsLegs_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
	 ...
	 */
	struct ABPChar_Operative_C_GetMaterialsSkeletalMesh_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
	 ...
	 */
	struct ABPChar_Operative_C_GetMaterialsFPGun_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
	 ...
	 */
	struct ABPChar_Operative_C_GetMaterialsTPGun_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
