...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_DI8E[0x8];                                   // 0x06F0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NMN6[0x6];                                   // 0x0702(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UBodySetup*>                                  BodySetups;                                              // 0x0708(0x0010) ZeroConstructor, Transient, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_10WT[0x28];                                  // 0x0718(0x0028) MISSED OFFSET (PADDING)
