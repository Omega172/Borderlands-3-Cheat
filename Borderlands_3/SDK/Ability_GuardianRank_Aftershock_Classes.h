...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0TH2[0x7];                                   // 0x0219(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnDeactivated();
		void OnActivated();
		void OnDamageCaused(class AActor* DamageInstigator, float Damage, class UGbxDamageType* DamageType, class UDamageSource* DamageSource, class AActor* DamagedActor, const struct FCausedDamageDetails& Details);
