...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1TWT[0x4];                                   // 0x0634(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_DestroyElixirInventory_ObjectivePROXY();
		void Obj_DestroyElixirInventory_ObjectivePROXY_1();
		...
		void Obj_SabotageElixirReginery_ObjectivePROXY_2();
		...
		void Obj_SabotageElixirReginery_ObjectivePROXY_3();
