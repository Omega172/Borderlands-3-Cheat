...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BYO0[0x2];                                   // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_45GU[0x14];                                  // 0x001C(0x0014) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		bool                                                       bLimit : 1;                                              // 0x0004(0x0001) BIT_FIELD Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_QRLC[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_58T8[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_AR13[0x610];                                 // 0x0000(0x0610) MISSED OFFSET (PADDING)
	};
