...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_M102[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_TH8B[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		EGbxActionEndState                                         ActionEndState;                                          // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_8FK9[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		class AActor*                                              Actor;                                                   // 0x0008(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct UAction_Phasetrance_Slam_Base_C_TriggerSlamBeginDialogue_Params
	{	};

	/**
	 * Function Action_Phasetrance_Slam_Base.Action_Phasetrance_Slam_Base_C.Trigger Slam Impact Dialogue
	 */
	struct UAction_Phasetrance_Slam_Base_C_TriggerSlamImpactDialogue_Params
	{	};

	/**
	 * Function Action_Phasetrance_Slam_Base.Action_Phasetrance_Slam_Base_C.Trigger slam Taunt Dialogue
	 */
	struct UAction_Phasetrance_Slam_Base_C_TriggerslamTauntDialogue_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_E29F[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
