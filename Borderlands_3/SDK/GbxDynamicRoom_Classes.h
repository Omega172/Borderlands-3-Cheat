...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_DJ4E[0x7];                                   // 0x0469(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KX9R[0x8];                                   // 0x04E8(0x0008) MISSED OFFSET (PADDING)
