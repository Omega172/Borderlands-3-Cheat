...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_FB34[0x7];                                   // 0x02B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void TriggerSlamBeginDialogue();
		void TriggerSlamImpactDialogue();
		void TriggerslamTauntDialogue();
