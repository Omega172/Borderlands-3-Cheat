...
namespace CG
{
	...
	public:
		...
		void Obj_MeetMaya_ObjectivePROXY();
		void Obj_MeetMaya_ObjectivePROXY_1();
		void Obj_ClearMayaArea(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_MeetMaya_ObjectivePROXY_2();
		...
		void Obj_MayaLeadToBell2_ObjectivePROXY_3();
		...
		void Obj_MayaLeadToBell2_ObjectivePROXY_4();
		...
		void Obj_ClearMayaAreaEarly_ObjectivePROXY_5();
		void SetanObjectiveintheDetails_6();
		...
		void OBJ_UseDropPod_ObjectivePROXY_7();
		...
		void Obj_GiveFragmentToTannis_ObjectivePROXY_8();
		...
		void StartConvo_AvaMeetsClaptrap_ObjectivePROXY_9();
		...
		void MCE_PlayerAtAreaToListenToMaya(class UObject* Context);
