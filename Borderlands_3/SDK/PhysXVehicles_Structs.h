...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9RMZ[0x1B];                                  // 0x001D(0x001B) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_8GN8[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_W0K7[0x4];                                   // 0x008C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_ZF64[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_4GGY[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DCJ6[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_D13Y[0x18];                                  // 0x0140(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_RDPD[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_P18X[0x20];                                  // 0x06C0(0x0020) MISSED OFFSET (PADDING)
	};
