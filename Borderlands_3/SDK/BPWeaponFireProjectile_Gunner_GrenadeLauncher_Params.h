...
namespace CG
{
	 ...
	 */
	struct UBPWeaponFireProjectile_Gunner_GrenadeLauncher_C_GetShotLightProjectileData_Params
	{
	public:
	 ...
	 */
	struct UBPWeaponFireProjectile_Gunner_GrenadeLauncher_C_SetNewGrenadeType_Params
	{
	public:
		bool                                                       bReadyForSingularityGrenade;                             // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};
	 ...
	 */
	struct UBPWeaponFireProjectile_Gunner_GrenadeLauncher_C_GetShotProjectileData_Params
	{
	public:
		class UClass*                                              ReturnValue;                                             // 0x0000(0x0008)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	};
	 ...
	 */
	struct UBPWeaponFireProjectile_Gunner_GrenadeLauncher_C_ReceiveBeginPlay_Params
	{	};
	 ...
	 */
	struct UBPWeaponFireProjectile_Gunner_GrenadeLauncher_C_ExecuteUbergraph_BPWeaponFireProjectile_Gunner_GrenadeLauncher_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_ROMP[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
