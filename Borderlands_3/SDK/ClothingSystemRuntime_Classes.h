...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9VW1[0x4];                                   // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J1OQ[0x4];                                   // 0x015C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_PWDE[0x10];                                  // 0x0030(0x0010) MISSED OFFSET (PADDING)
