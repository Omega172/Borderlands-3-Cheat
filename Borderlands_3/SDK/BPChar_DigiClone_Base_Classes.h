...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_I2S8[0x7];                                   // 0x2381(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_O6GC[0x3];                                   // 0x23CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XLZ3[0x3];                                   // 0x23DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y20B[0x7];                                   // 0x23E9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZHD3[0x4];                                   // 0x23FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y11X[0x7];                                   // 0x2429(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FDataTableValueHandle                               PanicButtonDamage;                                       // 0x2430(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		struct FDataTableValueHandle                               PanicButtonRadius;                                       // 0x2448(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		...
		unsigned char                                              UnknownData_SIN2[0x7];                                   // 0x2461(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3EZ1[0x4];                                   // 0x2484(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FTimerHandle                                        ProvokeSoundTimer;                                       // 0x24D8(0x0008) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		...
		unsigned char                                              UnknownData_857H[0x7];                                   // 0x24F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3501[0x3];                                   // 0x2505(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void TryConfigureProvoke(bool* Provokeequiped);
		...
		void AutomagicallyDealBonusDamage(class AActor* Actor, class UClass* DamageSource, float Damage);
