...
namespace CG
{
	...
	public:
		...
		class AActor*                                              CurrentPlayer;                                           // 0x06C8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		class UMissionObjective*                                   INV_Obj_VOGoToExterior_ObjVar;                           // 0x0728(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void INV_Obj_VOGoToExterior(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_VOGoToExterior(class UObject* Context);
		...
		void Obj_StallTheCarnivora_ObjectivePROXY();
		void Obj_StallTheCarnivora_ObjectivePROXY_1();
		...
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_2();
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_3();
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_4();
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_5();
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_6();
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_7();
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_8();
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_9();
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_10();
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_11();
		void Set_Carnivora_BadassWave(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_StallTheCarnivora_ObjectivePROXY_12();
		void Set_Carnivora_BadassWave2(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_StallTheCarnivora_ObjectivePROXY_13();
		...
		void Obj_GoToDesertZone_ObjectivePROXY_14();
		void Obj_GoToDesertZone_ObjectivePROXY_15();
		void Set_GoToHubTown(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Update_GoToHubTown(class UObject* Context);
		void Obj_GetIntoCarnivora_Overarc_ObjectivePROXY_16();
		void VOPlayMarcusSponsorVO(class UObject* Context);
		void Obj_EnterFestival_ObjectivePROXY_17();
		void Obj_RespawnGoldenChariot(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_RespawnGoldenChariot_ObjectivePROXY_18();
		void Obj_DriveGoldenChariot_ObjectivePROXY_19();
