...
namespace CG
{
	 ...
	 */
	void ABPWeap_BaseWeapon_C::GetIKOffsetData(bool DebugSockets, bool FirstPerson, const class FName& WeaponSocket_Left, const class FName& WeaponSocket_Right, struct FTransform* L_IK_Offset, struct FTransform* R_IK_Offset)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BPWeap_BaseWeapon.BPWeap_BaseWeapon_C.Get IK Offset Data");
		
		ABPWeap_BaseWeapon_C_GetIKOffsetData_Params params {};
