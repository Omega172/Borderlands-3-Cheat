...
namespace CG
{
	...
	public:
		...
		struct FDataTableValueHandle                               RicochetChance;                                          // 0x01B8(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		struct FDataTableValueHandle                               ActionSkillRicochetChance;                               // 0x01D0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		...
		struct FDataTableValueHandle                               RicochetDamage;                                          // 0x02B0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		struct FDataTableValueHandle                               ActionSkillRicochetdamage;                               // 0x02C8(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
