...
namespace CG
{
	...
	public:
		...
		bool                                                       FireAndSprintEnabled;                                    // 0x3618(0x0001) Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_BQEQ[0x3];                                   // 0x3619(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8C1T[0x4];                                   // 0x3654(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
