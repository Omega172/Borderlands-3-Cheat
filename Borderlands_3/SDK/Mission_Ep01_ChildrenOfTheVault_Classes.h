...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5RX9[0x4];                                   // 0x06EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_V9JJ[0x7];                                   // 0x0741(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_FollowClaptrap_ObjectivePROXY();
		...
		void Obj_FollowClaptrap_ObjectivePROXY_1();
		void Obj_FollowClaptrap_ObjectivePROXY_2();
		void Obj_FollowClaptrap_ObjectivePROXY_3();
		void Obj_FollowClaptrap_ObjectivePROXY_4();
		void Obj_FollowClaptrap_ObjectivePROXY_5();
		void Obj_FollowClaptrap_ObjectivePROXY_6();
		void Obj_ClaptrapMonologueAtScenicOverlook(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_FollowClaptrap_ObjectivePROXY_7();
		void Obj_FollowClaptrap_ObjectivePROXY_8();
		void Obj_FollowClaptrap_ObjectivePROXY_9();
		...
		void Obj_GetShield_ObjectivePROXY_10();
