...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RZLI[0x4];                                   // 0x069C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Inv_BreakGlass_Switch1_ObjectivePROXY();
		void Inv_BreakGlass_Switch2_ObjectivePROXY_1();
		void Inv_BreakGlass_Switch3_ObjectivePROXY_2();
		...
		void Inv_OpenSwitch2Door_ObjectivePROXY_3();
