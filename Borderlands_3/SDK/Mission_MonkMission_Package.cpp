...
namespace CG
{
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UMission_MonkMission_C::Obj_HarvestLivers_ObjectivePROXY()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Mission_MonkMission.Mission_MonkMission_C.[Obj_HarvestLivers_Objective] PROXY");
		
		UMission_MonkMission_C_Obj_HarvestLivers_ObjectivePROXY_Params params {};
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UMission_MonkMission_C::Obj_FloodRatch_ObjectivePROXY_1()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Mission_MonkMission.Mission_MonkMission_C.[Obj_FloodRatch_Objective] PROXY_1");
		
		UMission_MonkMission_C_Obj_FloodRatch_ObjectivePROXY_1_Params params {};
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UMission_MonkMission_C::Obj_KillBirthers_ObjectivePROXY_2()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Mission_MonkMission.Mission_MonkMission_C.[Obj_KillBirthers_Objective] PROXY_2");
		
		UMission_MonkMission_C_Obj_KillBirthers_ObjectivePROXY_2_Params params {};
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UMission_MonkMission_C::Obj_OpenBarrel02_ObjectivePROXY_3()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Mission_MonkMission.Mission_MonkMission_C.[Obj_OpenBarrel02_Objective] PROXY_3");
		
		UMission_MonkMission_C_Obj_OpenBarrel02_ObjectivePROXY_3_Params params {};
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UMission_MonkMission_C::Obj_OpenBarrel03_ObjectivePROXY_4()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Mission_MonkMission.Mission_MonkMission_C.[Obj_OpenBarrel03_Objective] PROXY_4");
		
		UMission_MonkMission_C_Obj_OpenBarrel03_ObjectivePROXY_4_Params params {};
