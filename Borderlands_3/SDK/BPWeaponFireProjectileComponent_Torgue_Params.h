...
namespace CG
{
	 ...
	 */
	struct UBPWeaponFireProjectileComponent_Torgue_C_K2_OnActivated_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_C9XD[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
