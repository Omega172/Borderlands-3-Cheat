...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_78FV[0x4];                                   // 0x0614(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_GiveBeansToCowboyA_ObjectivePROXY();
		...
		void Obj_GiveBeansToCowboyA_ObjectivePROXY_1();
		void Obj_DestroyBeans_ObjectivePROXY_2();
		void Set_GaveBeansToCowboyA2(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_GiveBeansToCowboyB_ObjectivePROXY_3();
		void Set_GaveBeansToCowboyB2(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_GiveBeansToCowboyB_ObjectivePROXY_4();
		void Set_DestroyedBeans2(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_GiveBeansToCowboyB_ObjectivePROXY_5();
		void Obj_GiveBeansToCowboyA_ObjectivePROXY_6();
		void Obj_GiveBeansToCowboyB_ObjectivePROXY_7();
		void Obj_DestroyBeans_ObjectivePROXY_8();
		...
		void Obj_GiveBeansToCowboyA_ObjectivePROXY_9();
		void Obj_GiveBeansToCowboyB_ObjectivePROXY_10();
		void Obj_GiveBeansToCowboyA_ObjectivePROXY_11();
		...
		void Invs_Clues_ObjectivePROXY_12();
