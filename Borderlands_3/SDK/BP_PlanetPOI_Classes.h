...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_47V6[0x8];                                   // 0x05A8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_DPAZ[0x3];                                   // 0x05C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UZoneMapData_Base_C*                                 ZoneMapData;                                             // 0x05E8(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
