...
namespace CG
{
	...
	public:
		...
		struct FRotator                                            CelestialBodyOrientation;                                // 0x04F8(0x000C) Edit, BlueprintVisible, IsPlainOldData, NoDestructor
		float                                                      CelestialBodyDistance;                                   // 0x0504(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      CelestialBodyScale;                                      // 0x0508(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
