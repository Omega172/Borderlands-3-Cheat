...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_V3YZ[0x3];                                   // 0x0675(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_Jump100meters_ObjectivePROXY();
		...
		void Obj_Jump100meters_ObjectivePROXY_1();
		...
		void Obj_DefaceStatue_ObjectivePROXY_2();
		...
		void Obj_DefaceStatue_ObjectivePROXY_3();
		...
		void Obj_DefaceStatue_ObjectivePROXY_4();
		...
		void Obj_KillShark_ObjectivePROXY_5();
		...
		void Obj_KillShark_ObjectivePROXY_6();
		...
		void Obj_Jump100meters_ObjectivePROXY_7();
		...
		void MissionKickoff();
		void Obj_DefaceStatue_ObjectivePROXY_8();
