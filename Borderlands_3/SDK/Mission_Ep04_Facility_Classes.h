...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_JBV9[0x7];                                   // 0x0519(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_StopDigiBombLaunch_ObjectivePROXY();
		void Obj_StopDigiBombLaunch_ObjectivePROXY_1();
		void Obj_StopDigiBombLaunch_ObjectivePROXY_2();
		void Obj_StopDigiBombLaunch_ObjectivePROXY_3();
		void Obj_StopDigiBombLaunch_ObjectivePROXY_4();
		void InvisObj_StopDigiBombWaypoint(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_StopDigiBombLaunch_ObjectivePROXY_5();
		void Obj_StopDigiBombLaunch_ObjectivePROXY_6();
		void Obj_StopDigiBombLaunch_ObjectivePROXY_7();
		...
		void Obj_StopDigiBombLaunch_ObjectivePROXY_8();
		...
		void Obj_StopDigiBombLaunch_ObjectivePROXY_9();
		...
		void Obj_StopDigiBombLaunch_ObjectivePROXY_10();
