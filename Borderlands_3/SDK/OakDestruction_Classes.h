...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UMHI[0x4];                                   // 0x0BDC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ET9V[0x4];                                   // 0x0C14(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UCXF[0x4C];                                  // 0x0C2C(0x004C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P77C[0x10];                                  // 0x0C80(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_O1KU[0x68];                                  // 0x0458(0x0068) MISSED OFFSET (PADDING)
