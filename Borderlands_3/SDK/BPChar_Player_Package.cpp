...
namespace CG
{
	 ...
	 * Parameters:
	 * 		int32_t                                            OldXPLevel                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		int32_t                                            NewXPLevel                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABPChar_Player_C::Player_LevelUp(int32_t OldXPLevel, int32_t NewXPLevel)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	void ABPChar_Player_C::Player_SpawnTransfusionProjectile(class UClass* DataBlueprintOverride, class UClass* DamageTypeOverride, class AActor* SourceActor, class AActor* TargetActor, float Damage, class AActor* CauserOverride)
	{
		static UFunction* fn = nullptr;
		if (!fn)
