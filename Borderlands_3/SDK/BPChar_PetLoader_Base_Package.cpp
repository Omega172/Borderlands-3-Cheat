...
namespace CG
{
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		struct FDamageReactionEventSummary                 DamageEvent                                                (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, ContainsInstancedReference)
	 */
	void ABPChar_PetLoader_Base_C::OnLeftLegJointDamaged(const struct FDamageReactionEventSummary& DamageEvent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FDamageReactionEventSummary                 DamageEvent                                                (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, ContainsInstancedReference)
	 */
	void ABPChar_PetLoader_Base_C::OnRightLegJointDamaged(const struct FDamageReactionEventSummary& DamageEvent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FDamageReactionEventSummary                 DamageEvent                                                (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, ContainsInstancedReference)
	 */
	void ABPChar_PetLoader_Base_C::OnLeftArmJointDamaged(const struct FDamageReactionEventSummary& DamageEvent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FDamageReactionEventSummary                 DamageEvent                                                (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, ContainsInstancedReference)
	 */
	void ABPChar_PetLoader_Base_C::OnRightArmJointDamaged(const struct FDamageReactionEventSummary& DamageEvent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
