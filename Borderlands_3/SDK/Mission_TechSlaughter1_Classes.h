...
namespace CG
{
	...
	public:
		...
		class ASlaughterGameMode*                                  SlaughterGameMode;                                       // 0x0530(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_I0RW[0x4];                                   // 0x0544(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IKHK[0x4];                                   // 0x0624(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_LightSwitchMover_ObjectivePROXY_4();
		void Obj_LightSwitchMover_ObjectivePROXY_5();
		void Obj_LightSwitchMover_ObjectivePROXY_6();
		void Obj_LightSwitchMover_ObjectivePROXY_7();
		...
		void Obj_INVIS_PlayersDiedinRound_ObjectivePROXY_8();
		void Obj_INVIS_PlayersDiedinRound_ObjectivePROXY_9();
		void Obj_INVIS_PlayersDiedinRound_ObjectivePROXY_10();
		void Obj_INVIS_PlayersDiedinRound_ObjectivePROXY_11();
