...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_OE6P[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		float                                                      TerrorCurrentValue;                                      // 0x0004(0x0004)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct UAbility_BloodyHarvest_Terror_C_UpdateTerror_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_43U8[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
