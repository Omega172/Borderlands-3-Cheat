...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TQJK[0x4];                                   // 0x0634(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_FindTitoNow_ObjectivePROXY();
		void Obj_FindTitoNow_ObjectivePROXY_1();
		void Obj_FindTitoNow_ObjectivePROXY_2();
		void Obj_FindTitoNow_ObjectivePROXY_3();
		void Obj_FindTitoNow_ObjectivePROXY_4();
		void Obj_FindTitoNow_ObjectivePROXY_5();
		void Advance_FindTitoNow(class UObject* Context);
		void Obj_FindTitoNow_ObjectivePROXY_6();
		void Obj_FindTitoNow_ObjectivePROXY_7();
		void Obj_FreeGlennAgain_ObjectivePROXY_8();
		void Obj_FreeGlennAgain_ObjectivePROXY_9();
