...
namespace CG
{
	 ...
	 */
	struct UPlayerAbility_Jump_C_GbxInpActEvt_InputAction_Discrete_Jump_K2Node_GbxInputActionEvent_Discrete_4_Params
	{
	public:
	 ...
	 */
	struct UPlayerAbility_Jump_C_GbxInpActEvt_InputAction_Discrete_Jump_K2Node_GbxInputActionEvent_Discrete_3_Params
	{
	public:
		class UGbxInputActionData_Discrete*                        Action;                                                  // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct UPlayerAbility_Jump_C_ExecuteUbergraph_PlayerAbility_Jump_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_IOC2[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
