...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5JOT[0x4];                                   // 0x0694(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_FindCommander_ObjectivePROXY();
		void Obj_FindCommander_ObjectivePROXY_1();
		void Obj_CoffeeCupAttackWaves(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_CoffeeCupAttackWaves_ObjectivePROXY_2();
		void Obj_CoffeeCupAttackWaves_ObjectivePROXY_3();
		void Obj_CoffeeCupAttackWaves_ObjectivePROXY_4();
