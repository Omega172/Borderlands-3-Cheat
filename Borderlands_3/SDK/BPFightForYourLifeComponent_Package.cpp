...
namespace CG
{
	 ...
	 * 		Flags  -> (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
	 */
	void UBPFightForYourLifeComponent_C::ReplenishAssaultRifleAmmoToSetPercentage()
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UBPFightForYourLifeComponent_C_ReplenishAssaultRifleAmmoToSetPercentage_Params params {};
