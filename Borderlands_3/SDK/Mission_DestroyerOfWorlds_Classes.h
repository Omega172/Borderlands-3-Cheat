...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_WAHV[0x4];                                   // 0x06E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GKXH[0x4];                                   // 0x0754(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4H14[0x7];                                   // 0x07A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OBJ_EscortNPC_Portal1_ObjectivePROXY();
		void OBJ_EscortNPC_Portal1_ObjectivePROXY_1();
		void OBJ_EscortNPC_Portal1_ObjectivePROXY_2();
		...
		void OBJ_EscortNPC_Portal2_ObjectivePROXY_3();
		void OBJ_EscortNPC_Portal2_ObjectivePROXY_4();
		void OBJ_EscortNPC_Portal2_ObjectivePROXY_5();
		...
		void OBJ_EscortNPC_Portal3_ObjectivePROXY_6();
		void OBJ_EscortNPC_Portal3_ObjectivePROXY_7();
		void OBJ_EscortNPC_Portal3_ObjectivePROXY_8();
