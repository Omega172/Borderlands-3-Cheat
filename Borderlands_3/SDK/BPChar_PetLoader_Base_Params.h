...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4VP5[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FDamageReactionEventSummary                         HitInfo;                                                 // 0x0010(0x0060)  (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, ContainsInstancedReference)
	};
	...
	{
	public:
		struct FDamageReactionEventSummary                         DamageEvent;                                             // 0x0000(0x0060)  (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, ContainsInstancedReference)
	};
