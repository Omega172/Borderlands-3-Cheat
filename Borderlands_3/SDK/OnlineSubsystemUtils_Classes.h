...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_V96L[0x8];                                   // 0x0068(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LOSQ[0x4];                                   // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_YJBO[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7671[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SBD1[0x8];                                   // 0x0068(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_U11W[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_OUNZ[0x8];                                   // 0x0540(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       LogPortUnreach : 1;                                      // 0x0548(0x0001) BIT_FIELD Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		bool                                                       AllowPlayerPortUnreach : 1;                              // 0x0548(0x0001) BIT_FIELD Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_V6EY[0x3];                                   // 0x0549(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_X9XL[0x28];                                  // 0x0550(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ABNI[0x28];                                  // 0x1970(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y6SC[0x4];                                   // 0x199C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_R0ZG[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_X9M4[0x78];                                  // 0x0050(0x0078) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VM2Y[0xC7];                                  // 0x00D1(0x00C7) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_T825[0xA0];                                  // 0x00D0(0x00A0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_556S[0xB8];                                  // 0x0028(0x00B8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_18VX[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_G9RP[0x168];                                 // 0x0028(0x0168) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_82VQ[0x6];                                   // 0x0192(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3S77[0x10];                                  // 0x0650(0x0010) MISSED OFFSET (PADDING)
