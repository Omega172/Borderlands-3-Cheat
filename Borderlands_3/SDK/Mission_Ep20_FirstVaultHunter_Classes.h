...
namespace CG
{
	...
	public:
		...
		int32_t                                                    CrystalGrabbed;                                          // 0x0518(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    CrystalPlaced;                                           // 0x051C(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    WeaponCrystalGrabbed;                                    // 0x0520(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    WeaponCrystalPlaced;                                     // 0x0524(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void MCEPlayerWentToCoordinates_BC4(class UObject* Context);
		...
		void MCEPlayerWentToCoordinatesPreCamp_BC2(class UObject* Context);
		...
		void Obj_GoToCoordiantes_ObjectivePROXY();
		void Obj_FollowFinchToResearchCenter(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void MCEPlayerArrivedAtResearchCenter(class UObject* Context);
		...
		void MCEPlayerWentToCoordinates_BC3(class UObject* Context);
		...
		void MCEPlayerWentToCoordinatesPreVines(class UObject* Context);
		...
		void MCEPlayerWentToCoordinatesPreCamp_BC1(class UObject* Context);
		...
		void OBJ_UseDropPod_ObjectivePROXY_3();
		...
		void MCEPlayerFollowedTyphon(class UObject* Context);
		...
		void MCETyphonArrivedAtWhipSpot(class UObject* Context);
		void INV_PlayeArrivedAtWhipSpot(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void MCEPlayerArrivedAtWhipSpot(class UObject* Context);
		void MCEPlayerMetTyphon(class UObject* Context);
		void MCETriggerTannisFillerVO_2(class UObject* Context);
		...
		void MCETriggerTannisFillerVO_3(class UObject* Context);
		...
		void MCETyphonDoneDemonstratingFabricator(class UObject* Context);
		void Obj_DoneFiringFinalFabricator(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void MCETyphonDoneFiringFinalFabricator(class UObject* Context);
		...
		void Obj_PlaceVaultKey_Desert_ObjectivePROXY_4();
		void Obj_PlaceVaultKey_Wetlands_ObjectivePROXY_5();
		void Obj_PlaceVaultKey_City_ObjectivePROXY_6();
