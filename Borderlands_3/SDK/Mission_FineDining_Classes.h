...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MYVU[0x4];                                   // 0x05E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_GetCactusFruit_ObjectivePROXY();
		...
		void SpawnSuccSkags();
		void Obj_DestroyCactus2_Invis_ObjectivePROXY_1();
		void Obj_DestroyCactus1_Invis_ObjectivePROXY_2();
		...
		void Obj_DestroyCactus3_Invis_ObjectivePROXY_3();
		void Obj_DestroyCactus4_Invis_ObjectivePROXY_4();
		void Obj_DestroyCactus5_Invis_ObjectivePROXY_5();
		...
		void Obj_KillAlphaSkag_ObjectivePROXY_6();
		...
		void Obj_KillBadassSkags_ObjectivePROXY_7();
		void Obj_KillMincemeat_ObjectivePROXY_8();
