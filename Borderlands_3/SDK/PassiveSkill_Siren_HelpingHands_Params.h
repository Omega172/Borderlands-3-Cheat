...
namespace CG
{
	 ...
	 */
	struct UPassiveSkill_Siren_HelpingHands_C_HelpingHandsonTakeAnyDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_3OJU[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_B52S[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
