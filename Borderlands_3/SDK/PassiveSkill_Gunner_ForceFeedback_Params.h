...
namespace CG
{
	 ...
	 */
	struct UPassiveSkill_Gunner_ForceFeedback_C_CapacitationOnCausedDeath_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_A9PH[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
