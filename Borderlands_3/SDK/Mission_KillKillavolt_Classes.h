...
namespace CG
{
	...
	public:
		...
		bool                                                       IsBetteriesActive_1;                                     // 0x0681(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_4LRT[0x2];                                   // 0x0682(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_KillBadGuy1_ObjectivePROXY();
		void Obj_KillBadGuy2_ObjectivePROXY_1();
		void Obj_KillBadGuy3_ObjectivePROXY_2();
