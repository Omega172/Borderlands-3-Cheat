...
namespace CG
{
	...
	public:
		...
		bool                                                       bVOTakeFirearmsFinished;                                 // 0x0519(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       bCompleteLoadTalkToBrick;                                // 0x051A(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       bCompleteLoadFrontDoor;                                  // 0x051B(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       bCompleteLoadHallDoor;                                   // 0x051C(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       bCompleteLoadReturnToppings;                             // 0x051D(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_2E8U[0x2];                                   // 0x051E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_14DH[0x4];                                   // 0x0524(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UMissionObjectiveSet*                                Set_FollowBrickChkpnt3_ObjSetVar;                        // 0x0710(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		class UMissionObjective*                                   DETONATORKillEnemy_INVS_ObjVar;                          // 0x0768(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		class UMissionObjective*                                   Obj_KillCoVVOcue_INVS_ObjVar;                            // 0x0788(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_Z6GH[0x6];                                   // 0x084A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UMissionObjective*                                   Obj_WainwrightVOINVS_ObjVar;                             // 0x0900(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		struct FDialogConversation                                 VOPizzaNag;                                              // 0x09C0(0x000C) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_4N33[0x4];                                   // 0x09CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_DeliverThePizza_ObjectivePROXY_2();
		void Obj_DeliverThePizza_ObjectivePROXY_3();
		...
		void Obj_FollowBrick_ObjectivePROXY_4();
		void Set_FollowBrickChkpnt3(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_FollowBrick_ObjectivePROXY_5();
		...
		void DETONATORKillEnemy_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_DetonatorKillEnemy(class UObject* Context);
		...
		void Obj_KillCoVVOcue_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_KillLodgeCoVVOcue(class UObject* Context);
		...
		void MCE_VOTinaIngredients(class UObject* Context);
		...
		void Obj_KillCoV_INVS_ObjectivePROXY_6();
		...
		void Obj_FindHammerlock_ObjectivePROXY_7();
		...
		void Obj_FindHammerlock_ObjectivePROXY_8();
		void Set_MeetMuscle(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_FindHammerlock_ObjectivePROXY_9();
		void Obj_MeetMuscle(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_MeetMuscle_ObjectivePROXY_10();
		void Obj_MeetMuscle_ObjectivePROXY_11();
		...
		void Obj_FollowBrick_ObjectivePROXY_12();
		...
		void Obj_FindHammerlock_ObjectivePROXY_13();
		void Obj_MeetMuscle_ObjectivePROXY_14();
		...
		void Obj_FindHammerlock_ObjectivePROXY_15();
		void Obj_FindHammerlock_ObjectivePROXY_16();
		void Obj_FindHammerlock_ObjectivePROXY_17();
		void Obj_EnterTinaRoom(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_FindTina_ObjectivePROXY_18();
		void Obj_FindHammerlock_ObjectivePROXY_19();
		void Obj_FindTina_ObjectivePROXY_20();
		void Obj_FindHammerlock_ObjectivePROXY_21();
		void Obj_FindTina_ObjectivePROXY_22();
		void Obj_FindHammerlock_ObjectivePROXY_23();
		void Obj_FindTina_ObjectivePROXY_24();
		...
		void Obj_FindHammerlock_ObjectivePROXY_25();
		void Obj_FindTina_ObjectivePROXY_26();
		void Obj_FindHammerlock_ObjectivePROXY_27();
		void Obj_FindTina_ObjectivePROXY_28();
		...
		void Obj_FindHammerlock_ObjectivePROXY_29();
		...
		void OBJ_UseDropPod_ObjectivePROXY_30();
		...
		void Obj_WainwrightVOINVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		...
		void Obj_FindHammerlock_ObjectivePROXY_31();
		void Obj_FollowBrick_ObjectivePROXY_32();
		void Obj_FindTina_ObjectivePROXY_33();
		...
		void Obj_FollowBrick_ObjectivePROXY_34();
		void Set_BrickOpenTinaDoor(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_FindHammerlock_ObjectivePROXY_35();
		void Obj_FindTina_ObjectivePROXY_36();
		...
		void Obj_DeliverThePizza_ObjectivePROXY_37();
		...
		void UPDATE_BCPrison01(class UObject* Context);
		void UPDATE_BCPrison02(class UObject* Context);
		void UPDATE_BCPrison03(class UObject* Context);
		void UPDATE_BCPrison04(class UObject* Context);
		void UPDATE_BCPrison05(class UObject* Context);
		void UPDATE_BCPrison06(class UObject* Context);
		void UPDATE_BCPrison07(class UObject* Context);
		void UPDATE_BCPrison08(class UObject* Context);
		void UPDATE_BCPrison09(class UObject* Context);
		...
		void Obj_GoToPrison_ObjectivePROXY_38();
		void Obj_MeetMuscle_ObjectivePROXY_39();
