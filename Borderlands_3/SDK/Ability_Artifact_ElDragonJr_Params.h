...
namespace CG
{
	 ...
	 */
	struct UAbility_Artifact_ElDragonJr_C_CausedDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_155S[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_QP41[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
