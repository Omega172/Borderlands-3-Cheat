...
namespace CG
{
	...
	public:
		...
		void Obj_ReachStationCore_ObjectivePROXY_7();
		void Set_ReachStationCore_GetChemicals(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_ReachStationCore_ObjectivePROXY_8();
		...
		void Obj_ReachStationCore_ObjectivePROXY_9();
		...
		void Obj_GoTowerSecurityPower_ObjectivePROXY_6();
		void Obj_GoTowerSecurityPower_ObjectivePROXY_5();
		void Obj_GoTowerSecurityPower_ObjectivePROXY_4();
		void Obj_GoTowerSecurityPower_ObjectivePROXY_3();
		...
		void Obj_ReachStationCore_ObjectivePROXY_10();
		...
		void Obj_GetPastSecurity_ObjectivePROXY_11();
		...
		void Obj_ReachStationCore_ObjectivePROXY_2();
		...
		void MissionKickoff();
		void Obj_ReachStationCore_ObjectivePROXY_1();
		void Obj_ReachStationCore_ObjectivePROXY();
