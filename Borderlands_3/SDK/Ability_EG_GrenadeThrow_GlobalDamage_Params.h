...
namespace CG
{
	 ...
	 */
	struct UAbility_EG_GrenadeThrow_GlobalDamage_C_ExecuteUbergraph_Ability_EG_GrenadeThrow_GlobalDamage_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_UW04[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
