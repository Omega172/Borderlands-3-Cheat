...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_IRA7[0x6];                                   // 0x07B2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PC7H[0x5];                                   // 0x07D3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
