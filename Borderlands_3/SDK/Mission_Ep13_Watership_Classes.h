...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_AYC0[0x7];                                   // 0x0761(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5JES[0x4];                                   // 0x083C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FDialogConversation                                 Dialog_PickUpBalexNag;                                   // 0x0878(0x000C) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_YVSA[0x4];                                   // 0x0884(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CF0V[0x4];                                   // 0x0954(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_SanctuaryGetToTheBridge_ObjectivePROXY();
		...
		void Obj_FindShip_ObjectivePROXY_1();
		void Obj_FindShip_ObjectivePROXY_2();
		void Obj_FindShip_ObjectivePROXY_3();
		...
		void Obj_FindKeyFragment_ObjectivePROXY_4();
		void Update_FindKeyFrag(class UObject* Context);
		void Obj_FindKeyFragment_ObjectivePROXY_5();
		void Obj_FindKeyFragment_ObjectivePROXY_6();
		void Obj_FindKeyFragment_ObjectivePROXY_7();
		void Obj_FindKeyFragment_ObjectivePROXY_8();
		void Obj_FindKeyFragment_ObjectivePROXY_9();
		void Obj_FindKeyFragment_ObjectivePROXY_10();
		void Obj_FindKeyFragment_ObjectivePROXY_11();
		void Obj_FindKeyFragment_ObjectivePROXY_12();
		void Obj_FindKeyFragment_ObjectivePROXY_13();
		void Obj_FindKeyFragment_ObjectivePROXY_14();
		void Obj_FindKeyFragment_ObjectivePROXY_15();
		void Obj_FindKeyFragment_ObjectivePROXY_16();
		void Obj_FindKeyFragment_ObjectivePROXY_17();
		void Obj_FindKeyFragment_ObjectivePROXY_18();
		void Obj_FindKeyFragment_ObjectivePROXY_19();
		void Obj_FindKeyFragment_ObjectivePROXY_20();
		void Obj_FindKeyFragment_ObjectivePROXY_21();
		void Obj_FindKeyFragment_ObjectivePROXY_22();
		void Obj_FindKeyFragment_ObjectivePROXY_23();
		void Obj_FindKeyFragment_ObjectivePROXY_24();
		void Obj_FindKeyFragment_ObjectivePROXY_25();
