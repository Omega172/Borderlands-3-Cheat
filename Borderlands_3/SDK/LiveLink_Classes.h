...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0YAH[0x10];                                  // 0x0188(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_WKDQ[0xE];                                   // 0x018A(0x000E) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_I8NT[0x58];                                  // 0x0028(0x0058) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JAQO[0xA8];                                  // 0x0028(0x00A8) MISSED OFFSET (PADDING)
