...
namespace CG
{
	...
	public:
		...
		void Obj_BossFightStart_ObjectivePROXY();
		...
		void Obj_BossFightStart_ObjectivePROXY_1();
		void MCE_Audio_RevenantSpawn(class UObject* Context);
		void Obj_KillBoss_ObjectivePROXY_2();
		...
		void Obj_CircleMove_2_ObjectivePROXY_3();
		void Obj_CircleStop_2_ObjectivePROXY_4();
