...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_FRDL[0x110];                                 // 0x0028(0x0110) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_OU1W[0x30];                                  // 0x0028(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FSQD[0x10];                                  // 0x0088(0x0010) MISSED OFFSET (PADDING)
