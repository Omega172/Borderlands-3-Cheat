...
namespace CG
{
	 ...
	 */
	struct UAbility_Artifact_BloodFrenzy_C_AmmoReturn_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_8CHG[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
