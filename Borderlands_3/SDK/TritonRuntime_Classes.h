...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RH7V[0x4];                                   // 0x02E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9Y8Y[0x5];                                   // 0x037B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y6MX[0x77];                                  // 0x0399(0x0077) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_G302[0x3];                                   // 0x045D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
