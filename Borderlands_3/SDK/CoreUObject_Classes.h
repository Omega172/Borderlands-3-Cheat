...
namespace CG
{
	...
	public:
		...
		void** /* I Changed this to a void** from a void* */	   VfTable;                                                 // 0x0000(0x0008) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_X2TM[0x68];                                  // 0x0028(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XV19[0x178];                                 // 0x0088(0x0178) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UVEQ[0x38];                                  // 0x0028(0x0038) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_J6MQ[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_CLWJ[0x10];                                  // 0x0088(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_F1W3VKC42S[0x01];                                    // 0x008F(0x0001) PRE-DEFINED PROPERTY
		...
		unsigned char                                              pad_NR9T0X4WVV[0x04];                                    // 0x00AC(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_LHI4[0x68];                                  // 0x0200(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_B5UM[0xB8];                                  // 0x0028(0x00B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WGBZ[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EBH3[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_IKHC[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_V5UT[0x1B8];                                 // 0x0200(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ESVQ[0xC8];                                  // 0x0028(0x00C8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_SYON[0x1B8];                                 // 0x00B8(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RME8[0xF0];                                  // 0x0028(0x00F0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_IF5E[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_24XR[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HBLP[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NS7P[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FH7Y[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_S8HX[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_W3Z9[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EOY7[0x38];                                  // 0x0070(0x0038) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UOLZ[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MRSC[0x28];                                  // 0x0070(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_9A15[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VF17[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
