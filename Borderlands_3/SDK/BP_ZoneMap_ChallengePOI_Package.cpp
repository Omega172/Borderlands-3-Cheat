...
namespace CG
{
	 ...
	 * 		Flags  -> (Public, BlueprintCallable, BlueprintEvent)
	 */
	void ABP_ZoneMap_ChallengePOI_C::BeginZoneMapCursorOver()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ZoneMap_ChallengePOI.BP_ZoneMap_ChallengePOI_C.Begin Zone Map Cursor Over");
		
		ABP_ZoneMap_ChallengePOI_C_BeginZoneMapCursorOver_Params params {};
