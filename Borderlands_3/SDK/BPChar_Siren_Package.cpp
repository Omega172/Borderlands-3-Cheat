...
namespace CG
{
	 ...
	 */
	void ABPChar_Siren_C::GetSirenGhostArmsComponent(class UGbxSkeletalMeshComponent** _3rdPersonMesh, class UGbxSkeletalMeshComponent** _1stPersonMesh)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	void ABPChar_Siren_C::GetSirenArmsReference(class UGbxSkeletalMeshComponent** SkelMesh3rd, class UGbxSkeletalMeshComponent** SkelMesh1st)
	{
		static UFunction* fn = nullptr;
		if (!fn)
