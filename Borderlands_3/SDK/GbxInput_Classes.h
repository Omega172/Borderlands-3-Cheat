...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_8C03[0x8];                                   // 0x0200(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZNZ5[0x70];                                  // 0x0280(0x0070) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_NJ77[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WBWE[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6KLI[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
