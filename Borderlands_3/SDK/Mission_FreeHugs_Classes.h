...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CSUV[0x4];                                   // 0x0674(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Q2MY[0x4];                                   // 0x06BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZQLY[0x4];                                   // 0x06E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_FindHolder_ObjectivePROXY();
		void Obj_FindHolder_ObjectivePROXY_1();
		void Obj_FindHolder_ObjectivePROXY_2();
