...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_DOCS[0x4];                                   // 0x231C(0x0004) Fix Super Size
	...
	public:
		...
		void AIExplosive_ThrowAtTarget(float ThrowSpeed, float ThrowAnglePercent, const class FName& TargetSocket, const struct FVector& TargetOffset, const struct FRotator& ThrowAngleOffset, float MaxPrediction, bool RequestNewExplosive, bool SpawnIfDoesntExist);
