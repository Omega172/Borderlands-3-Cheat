...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TAQ4[0x4];                                   // 0x087C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0BZ5[0x4];                                   // 0x08A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_ShootSpyCrates_ObjectivePROXY();
		void Obj_INV_WetlandsSpyCrate1_ObjectivePROXY_1();
		void Obj_INV_WetlandsSpyCrate2_ObjectivePROXY_2();
		void Obj_INV_WetlandsSpyCrate3_ObjectivePROXY_3();
		void Obj_ShootSpyCrates_ObjectivePROXY_4();
		void Obj_INV_WetlandsSpyCrate1_ObjectivePROXY_5();
		void Obj_INV_WetlandsSpyCrate2_ObjectivePROXY_6();
		void Obj_INV_WetlandsSpyCrate3_ObjectivePROXY_7();
