...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ZPUO[0x3];                                   // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_W9WY[0x7];                                   // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		ESetTelemetryValue                                         Opt;                                                     // 0x0044(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                              UnknownData_ISMP[0x3];                                   // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FK2TelemetryValues                                  ReturnValue;                                             // 0x0048(0x0028)  (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_99ED[0x3];                                   // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		ESetTelemetryValue                                         Opt;                                                     // 0x003C(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                              UnknownData_SNQT[0x3];                                   // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FK2TelemetryValues                                  ReturnValue;                                             // 0x0040(0x0028)  (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_HMX3[0x6];                                   // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FK2TelemetryValues                                  ReturnValue;                                             // 0x0040(0x0028)  (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
	};
	...
	public:
		...
		ESetTelemetryValue                                         Opt;                                                     // 0x0039(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		unsigned char                                              UnknownData_X7PW[0x6];                                   // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FK2TelemetryValues                                  ReturnValue;                                             // 0x0040(0x0028)  (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
	};
