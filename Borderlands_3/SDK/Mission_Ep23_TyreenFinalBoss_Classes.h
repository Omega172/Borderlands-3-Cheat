...
namespace CG
{
	...
	public:
		...
		void UpdateFinalBossMapEntered(class UObject* Context);
		...
		void UpdateLootVault(class UObject* Context);
		...
		void UpdateTalkedToTannisGameOver(class UObject* Context);
		void MissionKickoff();
		void UpdateTalkedToLilithGameOver(class UObject* Context);
		...
		void UpdatePlayCinematic(class UObject* Context);
		void Obj_TalkToTannisGameOver_ObjectivePROXY();
		...
		void UpdatePortalEntered(class UObject* Context);
