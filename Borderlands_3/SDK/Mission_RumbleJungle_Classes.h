...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_08NB[0x4];                                   // 0x064C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_ClearJabberInfestation_ObjectivePROXY();
		void Obj_JabberInfestation_1_Invis_ObjectivePROXY_1();
		void Obj_JabberInfestation_2_Invis_ObjectivePROXY_2();
		void Obj_JabberInfestation_3_Invis__ObjectivePROXY_3();
		...
		void Obj_FollowFailurebot_ObjectivePROXY_4();
		void Obj_FollowFailurebot_Invis_ObjectivePROXY_5();
		void Update_FollowFailurebot(class UObject* Context);
		void Obj_FindDeadScientists_ObjectivePROXY_6();
		...
		void Obj_CompleteTrials_Global_ObjectivePROXY_7();
		...
		void Obj_CompleteTrials_Global_ObjectivePROXY_8();
		void Obj_CompleteTrials_Global_ObjectivePROXY_9();
		...
		void Obj_CompleteTrials_Global_ObjectivePROXY_10();
		void Obj_CompleteTrials_Trial3_ObjectivePROXY_11();
		...
		void Obj_ArenaFight_KillQueen_ObjectivePROXY_12();
		...
		void Obj_CompleteTrials_Global_ObjectivePROXY_13();
		void Obj_CompleteTrials_Trial3_ObjectivePROXY_14();
