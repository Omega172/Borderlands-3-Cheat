...
namespace CG
{
	 ...
	 * 		Flags  -> (Public, BlueprintCallable, BlueprintEvent)
	 */
	void ABP_ZoneMap_FriendPOI_C::BeginZoneMapCursorOver()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ZoneMap_FriendPOI.BP_ZoneMap_FriendPOI_C.Begin Zone Map Cursor Over");
		
		ABP_ZoneMap_FriendPOI_C_BeginZoneMapCursorOver_Params params {};
