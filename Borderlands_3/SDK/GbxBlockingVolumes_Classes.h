...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PW8G[0x1];                                   // 0x049F(0x0001) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GBP3[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MXAW[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (PADDING)
