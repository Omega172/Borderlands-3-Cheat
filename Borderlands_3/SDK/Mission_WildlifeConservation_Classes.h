...
namespace CG
{
	...
	public:
		...
		class UMissionObjective*                                   Obj_VODistractMordi2_ObjVar;                             // 0x0638(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   BCEnterCavern1_ObjVar;                                   // 0x0640(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   BCEnterCavern2_ObjVar;                                   // 0x0648(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		bool                                                       CompleteLoadWalkThruOpening;                             // 0x0678(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void Obj_LookForTalon_ObjectivePROXY();
		void Obj_LookForTalon_ObjectivePROXY_1();
		void Obj_LookForTalon_ObjectivePROXY_2();
		void Obj_LookForTalon_ObjectivePROXY_3();
		void Obj_LookForTalon_ObjectivePROXY_4();
		void Obj_LookForTalon_ObjectivePROXY_5();
		void Obj_LookForTalon_ObjectivePROXY_6();
		...
		void Obj_FollowBlood_ObjectivePROXY_7();
		void Obj_FollowBlood_ObjectivePROXY_8();
		void Obj_FollowBlood_ObjectivePROXY_9();
		void Obj_FollowBlood_ObjectivePROXY_10();
		void Obj_FollowBlood_ObjectivePROXY_11();
		...
		void Obj_FollowTalon_ObjectivePROXY_12();
		...
		void Obj_VODistractMordi2(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_VODistractMordi2(class UObject* Context);
		void Set_EnterCavern1(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void UPDATE_InvestigateBody(class UObject* Context);
		void BCEnterCavern1(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void BCEnterCavern2(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_BCEnterCavern1(class UObject* Context);
		void UPDATE_BCEnterCavern2(class UObject* Context);
