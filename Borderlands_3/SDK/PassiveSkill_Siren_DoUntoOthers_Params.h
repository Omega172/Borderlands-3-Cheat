...
namespace CG
{
	 ...
	 */
	struct UPassiveSkill_Siren_DoUntoOthers_C_DoHarmOnTookDamage_Params
	{
	public:
		...
		unsigned char                                              UnknownData_4YKA[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
