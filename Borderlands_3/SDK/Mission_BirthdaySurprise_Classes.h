...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_AF1L[0x6];                                   // 0x0612(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UMissionObjectiveSet*                                Set_VOCakeRecordBroken_ObjSetVar;                        // 0x0628(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_VOCakeRecordBroken_INVS_ObjVar;                      // 0x0630(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjectiveSet*                                Set_VOCakeRecordStands_ObjSetVar;                        // 0x0638(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_VOCakeRecordStands_INVS_ObjVar;                      // 0x0640(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjectiveSet*                                Set_VOGrenadeRecordBroken_ObjSetVar;                     // 0x0648(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjectiveSet*                                Set_VOGrenadeRecordStands_ObjSetVar;                     // 0x0650(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_VOGrenadeRecordBroken_INVS_ObjVar;                   // 0x0658(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_VOGrenadeRecordStands_INVS_ObjVar;                   // 0x0660(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjectiveSet*                                Set_VOShootingRecordBroken_ObjSetVar;                    // 0x0668(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjectiveSet*                                Set_VOShootingRecordStands_ObjSetVar;                    // 0x0670(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_VOShootingRecordBroken_INVS_ObjVar;                  // 0x0678(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_VOShootingRecordStands_INVS_ObjVar;                  // 0x0680(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		class UMissionObjective*                                   Obj_Timer60sLeft_ObjVar;                                 // 0x0690(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_Timer30sLeft_ObjVar;                                 // 0x0698(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_Timer10sLeft_ObjVar;                                 // 0x06A0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_Timer5sLeft_ObjVar;                                  // 0x06A8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_8COE[0x7];                                   // 0x06C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void MCE_Grenade1pnt(class UObject* Context);
		void MCE_BrokeGrenadeRecord(class UObject* Context);
		void MCE_Grenade5pnts(class UObject* Context);
		void MCE_Grenade10pnts(class UObject* Context);
		...
		void Obj_BreakCakeRecord_ObjectivePROXY();
		void Set_VOCakeRecordBroken(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_BreakCakeRecord_ObjectivePROXY_1();
		void Obj_VOCakeRecordBroken_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Set_VOCakeRecordStands(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_SayYoureFull_ObjectivePROXY_2();
		void Obj_VOCakeRecordStands_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void SetanObjectiveintheDetails_3();
		void SetanObjectiveintheDetails_4();
		void Obj_BreakGrenadeRecord_ObjectivePROXY_5();
		void Set_VOGrenadeRecordBroken(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Set_VOGrenadeRecordStands(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_BreakGrenadeRecord_ObjectivePROXY_6();
		void Obj_VOGrenadeRecordBroken_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_SayYoureTired_ObjectivePROXY_7();
		void Obj_VOGrenadeRecordStands_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Set_VOShootingRecordBroken(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Set_VOShootingRecordStands(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_BreakShootingRecord_ObjectivePROXY_8();
		void Obj_VOShootingRecordBroken_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_LeaveShootingRecord_ObjectivePROXY_9();
		void Obj_VOShootingRecordStands_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_BrokenRecordTracker_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_BrokenRecordTracker_INVS_ObjectivePROXY_10();
		void Obj_BrokenRecordTracker_INVS_ObjectivePROXY_11();
		void UPDATE_LeaveShootingRecord(class UObject* Context);
		void Obj_Timer60sLeft(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_Timer60sLeft(class UObject* Context);
		void Obj_Timer30sLeft(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_Timer30sLeft(class UObject* Context);
		void Obj_Timer10sLeft(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_Timer10sLeft(class UObject* Context);
		void Obj_Timer5sLeft(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_Timer5sLeft(class UObject* Context);
		...
		void Obj_CollectFlowers_ObjectivePROXY_12();
