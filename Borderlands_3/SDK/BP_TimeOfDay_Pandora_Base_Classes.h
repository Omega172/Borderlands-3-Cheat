...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_1GF0[0x4];                                   // 0x050C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6BJ5[0x3];                                   // 0x0541(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void GetWorldPhaseLockStart(struct FVector* WorldLocation);
