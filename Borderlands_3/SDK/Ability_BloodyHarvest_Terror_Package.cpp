...
namespace CG
{
	 ...
	 * 		float                                              TerrorCurrentValue                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UAbility_BloodyHarvest_Terror_C::GetTerrorResourcePoolValues(bool* IsValid, float* TerrorCurrentValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		if (TerrorCurrentValue != nullptr)
			*TerrorCurrentValue = params.TerrorCurrentValue;
	}
	 ...
	 */
	void UAbility_BloodyHarvest_Terror_C::UpdateTerror(const struct FGameResourcePoolReference& ResourcePool)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Ability_BloodyHarvest_Terror.Ability_BloodyHarvest_Terror_C.Update Terror");
		
		UAbility_BloodyHarvest_Terror_C_UpdateTerror_Params params {};
