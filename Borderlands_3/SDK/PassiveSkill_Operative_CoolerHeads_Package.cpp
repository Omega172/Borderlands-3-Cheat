...
namespace CG
{
	 ...
	 */
	void UPassiveSkill_Operative_CoolerHeads_C::ExperimentalBulletsonCritialHit(class AActor* DamageInstigator, float Damage, class UGbxDamageType* DamageType, class UDamageSource* DamageSource, class AActor* DamagedActor, const struct FCausedDamageDetails& Details)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UPassiveSkill_Operative_CoolerHeads_C_ExperimentalBulletsonCritialHit_Params params {};
