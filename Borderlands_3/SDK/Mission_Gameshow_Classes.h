...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ZKGO[0x5];                                   // 0x0523(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void MissionKickoff();
		void Obj_StandAtPodium_ObjectivePROXY_3();
