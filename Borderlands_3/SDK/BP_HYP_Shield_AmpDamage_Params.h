...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3JGK[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UBP_HYP_Shield_AmpDamage_C_WeaponEquip_Params
	{	};

	/**
	 * Function BP_HYP_Shield_AmpDamage.BP_HYP_Shield_AmpDamage_C.Weapon Put Down
	 */
	struct UBP_HYP_Shield_AmpDamage_C_WeaponPutDown_Params
	{
	public:
