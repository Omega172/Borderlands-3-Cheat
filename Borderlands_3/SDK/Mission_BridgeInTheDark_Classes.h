...
namespace CG
{
	...
	public:
		...
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_1();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_2();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_3();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_4();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_5();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_6();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_7();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_8();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_9();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_10();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_11();
		void OBJ_ListenLostAlkonostLog_ObjectivePROXY_12();
