...
namespace CG
{
	...
	public:
		...
		void Obj_SaveCasino_ObjectivePROXY();
		void Obj_SaveCasino_ObjectivePROXY_1();
		void Obj_SaveCasino_ObjectivePROXY_2();
		void Set_PlaySeq_4(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_SaveCasino_ObjectivePROXY_3();
		void Set_PlaySeq_5(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_SaveCasino_ObjectivePROXY_4();
		void Obj_SaveCasino_ObjectivePROXY_5();
		void Set_PlaySeq_6(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_SaveCasino_ObjectivePROXY_6();
		...
		void Obj_GoToBlastDoor_ObjectivePROXY_7();
		...
		void Obj_ClearAreaPreThermite_PreCheck_ObjectivePROXY_8();
		void Obj_ClearAreaPreThermite_PreCheck_ObjectivePROXY_9();
		...
		void INV_Obj_PlayerNearEmber_ObjectivePROXY_10();
		void INV_Obj_PlayerNearEmber_ObjectivePROXY_11();
		void INV_Obj_PlayerNearEmber_ObjectivePROXY_12();
		...
		void INV_ClearLobby_Precheck_ObjectivePROXY_13();
