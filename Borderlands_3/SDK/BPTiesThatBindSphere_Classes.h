...
namespace CG
{
	...
	public:
		...
		struct FDataTableValueHandle                               WebSphereRadius;                                         // 0x0620(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		struct FDataTableValueHandle                               WebDuration;                                             // 0x0638(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
