...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_K8XA[0x4];                                   // 0x02F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SKDT[0x38];                                  // 0x0308(0x0038) MISSED OFFSET (PADDING)
