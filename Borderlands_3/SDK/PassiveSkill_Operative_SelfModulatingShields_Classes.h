...
namespace CG
{
	...
	public:
		...
		struct FStatusEffectInstanceReference                      StatusEffectModifier;                                    // 0x01B8(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, ContainsInstancedReference
	...
	public:
		void RemoveStatusEffectModifier();
		void AddStatusEffectModifier();
		void OnActivated();
		void SelfModulatingShieldsOnTakeAnyDamage(class UDamageComponent* DamageReceiver, float Damage, class UGbxDamageType* DamageType, class UDamageSource* DamageSource, class AController* InstigatedBy, class UDamageCauserComponent* DamageCauser, const struct FReceivedDamageDetails& Details);
