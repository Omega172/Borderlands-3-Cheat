...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NO65[0x30];                                  // 0x0058(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8XHY[0x150];                                 // 0x00A8(0x0150) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZHRE[0x68];                                  // 0x0038(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WB2H[0xA8];                                  // 0x00A0(0x00A8) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_KITY[0x140];                                 // 0x0030(0x0140) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HIKH[0x8];                                   // 0x0178(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_E31Q[0x10];                                  // 0x01A8(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_L9HY[0xE0];                                  // 0x00A0(0x00E0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_6FIT[0x8];                                   // 0x0148(0x0008) Fix Super Size
		unsigned char                                              UnknownData_DJ2U[0x90];                                  // 0x0150(0x0090) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FUP1[0x8];                                   // 0x0148(0x0008) Fix Super Size
		unsigned char                                              UnknownData_1CRL[0x50];                                  // 0x0150(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UOYM[0x8];                                   // 0x0158(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_KYBJ[0x130];                                 // 0x00A0(0x0130) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RBHZ[0x18];                                  // 0x00A8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_STLS[0x8];                                   // 0x0148(0x0008) Fix Super Size
		unsigned char                                              UnknownData_BF5E[0x10];                                  // 0x0150(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_RVCN[0x20];                                  // 0x00B0(0x0020) MISSED OFFSET (PADDING)
