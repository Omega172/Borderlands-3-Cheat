...
namespace CG
{
	...
	public:
		...
		class UGbxSkeletalMeshComponent*                           GhostArms3rd;                                            // 0x3620(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_ERWG[0x3];                                   // 0x362D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YGVE[0x3];                                   // 0x363D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UGbxSkeletalMeshComponent*                           GhostArms1st;                                            // 0x3648(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
