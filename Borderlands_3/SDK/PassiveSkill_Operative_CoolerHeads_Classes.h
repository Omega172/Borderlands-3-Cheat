...
namespace CG
{
	...
	public:
		...
		struct FDataTableValueHandle                               FreezeChance;                                            // 0x01B8(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
	...
	public:
		void OnActivated();
		void ExperimentalBulletsonCritialHit(class AActor* DamageInstigator, float Damage, class UGbxDamageType* DamageType, class UDamageSource* DamageSource, class AActor* DamagedActor, const struct FCausedDamageDetails& Details);
