...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FIHH[0x3];                                   // 0x0981(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VQOM[0x4];                                   // 0x09B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void JokeReload();
		void GetIKOffsetData(bool DebugSockets, bool FirstPerson, const class FName& WeaponSocket_Left, const class FName& WeaponSocket_Right, struct FTransform* L_IK_Offset, struct FTransform* R_IK_Offset);
