...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_G0T0[0x4];                                   // 0x04B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_O4YZ[0xB];                                   // 0x0395(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8AB3[0xF];                                   // 0x03A1(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JYW2[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_I60T[0x3];                                   // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_KM9E[0x2];                                   // 0x0036(0x0002) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_DEOC[0x7];                                   // 0x0041(0x0007) MISSED OFFSET (PADDING)
