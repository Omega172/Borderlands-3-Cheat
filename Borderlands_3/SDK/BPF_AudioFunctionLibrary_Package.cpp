...
namespace CG
{
	 ...
	 */
	void UBPF_AudioFunctionLibrary_C::STATIC_GetDistanceBetweenVectors(const struct FVector& Vector1, const struct FVector& Vector2, class UObject* __WorldContext, float* Distance)
	{
		static UFunction* fn = nullptr;
		if (!fn)
