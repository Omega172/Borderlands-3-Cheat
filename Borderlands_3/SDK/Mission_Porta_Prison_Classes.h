...
namespace CG
{
	 ...
	 */
	class UMission_PortaPrison_C : public UBP_OakMission_C
	{
	public:
		...
		unsigned char                                              UnknownData_65ZW[0x4];                                   // 0x0644(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_INV_PottyMusic_ObjectivePROXY();
		void Obj_INV_PottyMusic_ObjectivePROXY_1();
		...
		void Obj_INV_PottyMusic_ObjectivePROXY_2();
		...
		void ExecuteUbergraph_Mission_PortaPrison(int32_t EntryPoint);
