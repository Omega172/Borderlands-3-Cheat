...
namespace CG
{
	...
	public:
		...
		class UParticleSystemComponent*                            BoosterFX;                                               // 0x0750(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_JKA6[0x4];                                   // 0x078C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
