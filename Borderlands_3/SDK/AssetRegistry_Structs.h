...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FDVK[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_6R2I[0x50];                                  // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3TTR[0x4];                                   // 0x00E4(0x0004) MISSED OFFSET (PADDING)
	};
