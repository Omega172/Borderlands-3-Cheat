...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_C5T1[0x8];                                   // 0x0718(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_OTUA[0x6];                                   // 0x0722(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3VE9[0x4];                                   // 0x076C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
