...
namespace CG
{
	...
	public:
		...
		bool                                                       ActiveLoadWaitForIt;                                     // 0x062C(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void Obj_BeatriceInKitchen_ObjectivePROXY();
