...
namespace CG
{
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UMission_ProvingGroundsDiscovery_Mission01_C::OBJ_UseDropPod_ObjectivePROXY()
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UMission_ProvingGroundsDiscovery_Mission01_C_OBJ_UseDropPod_ObjectivePROXY_Params params {};
