...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4FFE[0x4];                                   // 0x0704(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4VQF[0x4];                                   // 0x072C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OBJ_EnterWestTown_ObjectivePROXY();
		void OBJ_EnterWestTown_ObjectivePROXY_1();
		void OBJ_EnterWestTown_ObjectivePROXY_2();
		void OBJ_EnterWestTown_ObjectivePROXY_3();
		...
		void OBJ_EnterWestTown_ObjectivePROXY_4();
		void Update_FollowRose2(class UObject* Context);
		void OBJ_EnterWestTown_ObjectivePROXY_5();
		...
		void OBJ_AskBartenderAboutRose_ObjectivePROXY_6();
		void OBJ_ShootPiano_ObjectivePROXY_7();
		...
		void OBJ_EnterWestTown_ObjectivePROXY_8();
		...
		void OBJ_EnterWestTown_ObjectivePROXY_9();
		...
		void OBJ_EnterWestTown_ObjectivePROXY_10();
		void OBJ_EnterWestTown_ObjectivePROXY_11();
		...
		void OBJ_EnterWestTown_ObjectivePROXY_12();
