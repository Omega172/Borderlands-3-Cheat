...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_C5RL[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UIBPChar_DigiClone_C_GetOwnersGrenadeProjectileClass_Params
	{
	public:
