...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_MB5K[0x8];                                   // 0x0AE8(0x0008) Fix Super Size
		...
		class FName                                                LegAO;                                                   // 0x2568(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
