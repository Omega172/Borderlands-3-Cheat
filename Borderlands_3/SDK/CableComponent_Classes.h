...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_NXOW[0x8];                                   // 0x0718(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_73G6[0x1];                                   // 0x075F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_14WT[0xA0];                                  // 0x0790(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_29XA[0x3];                                   // 0x01C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IC0T[0x4];                                   // 0x01CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UYDE[0x1];                                   // 0x01E3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QEI4[0x8];                                   // 0x01F8(0x0008) MISSED OFFSET (PADDING)
