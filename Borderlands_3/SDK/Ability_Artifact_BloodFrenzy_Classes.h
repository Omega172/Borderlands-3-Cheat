...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_2QHY[0x6];                                   // 0x011A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8UH1[0x4];                                   // 0x012C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void AmmoReturn(class AOakCharacter* Character);
		void OnActivated();
