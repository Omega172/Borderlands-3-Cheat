...
namespace CG
{
	 ...
	 */
	struct ABPChar_StandIn_Operative_SkillScreen_C_UserConstructionScript_Params
	{	};

	/**
	 * Function BPChar_StandIn_Operative_SkillScreen.BPChar_StandIn_Operative_SkillScreen_C.ShowShoulderCannon
	 */
	struct ABPChar_StandIn_Operative_SkillScreen_C_ShowShoulderCannon_Params
	{	};

	/**
	 * Function BPChar_StandIn_Operative_SkillScreen.BPChar_StandIn_Operative_SkillScreen_C.HideShoulderCannon
	 */
	struct ABPChar_StandIn_Operative_SkillScreen_C_HideShoulderCannon_Params
	{	};
	 ...
	 */
	struct ABPChar_StandIn_Operative_SkillScreen_C_ExecuteUbergraph_BPChar_StandIn_Operative_SkillScreen_Params
	{
	public:
