...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UWI6[0x3];                                   // 0x13AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K65A[0x4];                                   // 0x13BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
