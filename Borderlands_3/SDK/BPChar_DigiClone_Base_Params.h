...
namespace CG
{
	 ...
	 */
	struct ABPChar_DigiClone_Base_C_GetOwnersGrenadeProjectileClass_Params
	{
	public:
		class UClass*                                              GrenadeProjectileClass;                                  // 0x0000(0x0008)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	{
	public:
		bool                                                       Provokeequiped;                                          // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_EUYB[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_654Y[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct ABPChar_DigiClone_Base_C_AutomagicallyDealBonusDamage_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_P04U[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct ABPChar_DigiClone_Base_C_SetupLivesofOthers_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_FS5P[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
