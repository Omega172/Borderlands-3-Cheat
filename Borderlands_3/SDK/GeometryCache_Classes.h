...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_4KXL[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0OOC[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_YSRA[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VJ16[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FM27[0x2];                                   // 0x0722(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HXPT[0x30];                                  // 0x0734(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P2QJ[0x7];                                   // 0x0769(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_W2XQ[0x2C];                                  // 0x002C(0x002C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7E15[0x24];                                  // 0x005C(0x0024) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2KCW[0x128];                                 // 0x0060(0x0128) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LPBB[0x4];                                   // 0x018C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PVN9[0xA8];                                  // 0x0058(0x00A8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WV3K[0xA8];                                  // 0x0058(0x00A8) MISSED OFFSET (PADDING)
