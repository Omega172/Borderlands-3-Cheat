...
namespace CG
{
	 ...
	 */
	struct ABP_PlanetPOI_C_ActivatePOI_Params
	{	};
	 ...
	 */
	struct ABP_PlanetPOI_C_EndZoneMapCursorOver_Params
	{	};

	/**
	 * Function BP_PlanetPOI.BP_PlanetPOI_C.Begin Zone Map Cursor Over
	 */
	struct ABP_PlanetPOI_C_BeginZoneMapCursorOver_Params
	{	};

	/**
	 * Function BP_PlanetPOI.BP_PlanetPOI_C.Highlight POI
	 */
	struct ABP_PlanetPOI_C_HighlightPOI_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_TCS9[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
