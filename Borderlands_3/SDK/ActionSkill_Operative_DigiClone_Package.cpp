...
namespace CG
{
	 ...
	 */
	void UActionSkill_Operative_DigiClone_C::IsDigiCloneActive(bool* Return)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UActionSkill_Operative_DigiClone_C_IsDigiCloneActive_Params params {};
	 ...
	 * 		Flags  -> (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
	 */
	void UActionSkill_Operative_DigiClone_C::AddSwapPlacesModifier()
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UActionSkill_Operative_DigiClone_C_AddSwapPlacesModifier_Params params {};
	 ...
	 */
	void UActionSkill_Operative_DigiClone_C::JustAcceptItTimerDone()
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UActionSkill_Operative_DigiClone_C_JustAcceptItTimerDone_Params params {};
