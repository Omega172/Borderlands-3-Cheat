...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5F6X[0x4];                                   // 0x05C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XBWC[0x4];                                   // 0x05E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SZMM[0x4];                                   // 0x063C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PJUG[0x4];                                   // 0x066C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FDialogConversation                                 BadassLine2;                                             // 0x0684(0x000C) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void OBJ_ClimbTheMountain_ObjectivePROXY();
		...
		void OBJ_ClimbTheMountain_ObjectivePROXY_1();
		...
		void OBJ_ClimbTheMountain_ObjectivePROXY_2();
