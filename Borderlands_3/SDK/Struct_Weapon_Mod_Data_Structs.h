...
namespace CG
{
	...
	public:
		...
		float                                                      ShotgunAccuracyMinSpread_117_AB9A347B4CAA14AA041949BD1D9AE179; // 0x001C(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
