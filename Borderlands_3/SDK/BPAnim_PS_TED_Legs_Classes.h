...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_JFL7[0x8];                                   // 0x0AE8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_1TZK[0x8];                                   // 0x1168(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
