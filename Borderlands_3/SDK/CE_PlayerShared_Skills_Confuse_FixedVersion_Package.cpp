...
namespace CG
{
	 ...
	 */
	void UCE_PlayerShared_Skills_Confuse_FixedVersion_C::OnConfuseTargetdeath(class AActor* DamageReceiver, class AActor* DamageCauser)
	{
		...
		UCE_PlayerShared_Skills_Confuse_FixedVersion_C_OnConfuseTargetdeath_Params params {};
