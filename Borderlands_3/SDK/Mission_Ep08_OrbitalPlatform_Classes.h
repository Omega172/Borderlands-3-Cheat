...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9NZY[0x4];                                   // 0x080C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CPIS[0x4];                                   // 0x0854(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RHVX[0x4];                                   // 0x0884(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IPHO[0x4];                                   // 0x0954(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_GoToRhysLaunchPad_ObjectivePROXY();
		...
		void Obj_SecurityNearElevator_ObjectivePROXY_1();
		...
		void Obj_FollowRhysBall_ObjectivePROXY_2();
		...
		void Obj_FollowRhysBall_ObjectivePROXY_3();
		...
		void Obj_FollowRhysBall_ObjectivePROXY_4();
		...
		void Obj_FollowRhysBall_ObjectivePROXY_5();
		...
		void Obj_GiveFragmentToTannis_ObjectivePROXY_6();
