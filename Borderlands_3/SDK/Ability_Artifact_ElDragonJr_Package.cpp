...
namespace CG
{
	 ...
	 */
	void UAbility_Artifact_ElDragonJr_C::CausedDamage(class AActor* DamageInstigator, float Damage, class UGbxDamageType* DamageType, class UDamageSource* DamageSource, class AActor* DamagedActor, const struct FCausedDamageDetails& Details)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Ability_Artifact_ElDragonJr.Ability_Artifact_ElDragonJr_C.Caused Damage");
		
		UAbility_Artifact_ElDragonJr_C_CausedDamage_Params params {};
