...
namespace CG
{
	...
	public:
		...
		void Obj_FollowSaurian_ObjectivePROXY();
		void Set_GatherBloom_Red(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_GatherBloom_Green_ObjectivePROXY_1();
		void Obj_FollowSaurian_ObjectivePROXY_2();
		...
		void Obj_GatherBloom_Green_ObjectivePROXY_3();
		void Obj_GatherBloom_Invis_ObjectivePROXY_4();
		...
		void Obj_WieldMissionWeapon_ObjectivePROXY_5();
		void Update_DestroyVat(class UObject* Context);
		void ME_ReachWitchArea(class UObject* Context);
