...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_2A38[0x7];                                   // 0x01C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RVDW[0x5];                                   // 0x01D3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
