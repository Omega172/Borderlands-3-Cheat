...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CRC0[0x4];                                   // 0x0644(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CG10[0x4];                                   // 0x0794(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U8TG[0x4];                                   // 0x07B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_18XN[0x4];                                   // 0x07D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NMA7[0x4];                                   // 0x08CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void MCE_PlayerrendezvouswithClay(class UObject* Context);
		void MCE_Playerarrivesatthecaveentry(class UObject* Context);
		void MCE_PlayerdefeatsAurelia(class UObject* Context);
		void MCE_Playerarrivesattheestategrounds(class UObject* Context);
		void MCE_Playerhasenteredthevaultisland(class UObject* Context);
		void Update_VaultOpened(class UObject* Context);
		void MCE_Playerhasdefeatedthevaultmonster(class UObject* Context);
		void MCE_PlayerhasreturnedtoLilithonSanctuary3(class UObject* Context);
		...
		void MCE_TriggerAureliaTitleCard(class UObject* Context);
		...
		void MCE_Playerrevealsoneoftheruins(class UObject* Context);
		void Obj_RevealRuins(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_RevealRuins_ObjectivePROXY_1();
		void Obj_RevealRuins_ObjectivePROXY_2();
		...
		void Obj_ReturnToSanc_ObjectivePROXY_4();
