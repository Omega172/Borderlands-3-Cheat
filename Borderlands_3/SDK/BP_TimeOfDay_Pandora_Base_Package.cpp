...
namespace CG
{
	 ...
	 * Parameters:
	 * 		struct FVector                                     WorldLocation                                              (Parm, OutParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_TimeOfDay_Pandora_Base_C::GetWorldPhaseLockStart(struct FVector* WorldLocation)
	{
