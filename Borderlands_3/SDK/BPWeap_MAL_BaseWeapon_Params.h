...
namespace CG
{
	 ...
	 */
	struct ABPWeap_MAL_BaseWeapon_C_InitializeElementalEmissive_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_C640[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
