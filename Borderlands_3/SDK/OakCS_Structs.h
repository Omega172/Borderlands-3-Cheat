...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_WM4A[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_Z390[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_BDSP[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
	};
