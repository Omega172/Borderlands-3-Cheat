...
namespace CG
{
	 ...
	 * 		Flags  -> (Public, HasOutParms, BlueprintCallable, BlueprintEvent, BlueprintPure)
	 * Parameters:
	 * 		class UOakActionAbilityAugmentData*                HardPoint                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		bool                                               res                                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABPChar_IronCub_V3_C::TestHardpoint(class UOakActionAbilityAugmentData* HardPoint, bool* res)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Parameters:
	 * 		class UOakActionAbilityAugmentSlotData*            HardPointSlot                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		class UClass*                                      res                                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABPChar_IronCub_V3_C::SetupHardpointBlackboard(class UOakActionAbilityAugmentSlotData* HardPointSlot, class UClass** res)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		params.HardPointSlot = HardPointSlot;
