...
namespace CG
{
	...
	public:
		...
		struct FDialogConversation                                 ConvoTinaDoting;                                         // 0x05F0(0x000C) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
		struct FDialogConversation                                 ConvoPastEnriques;                                       // 0x05FC(0x000C) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
