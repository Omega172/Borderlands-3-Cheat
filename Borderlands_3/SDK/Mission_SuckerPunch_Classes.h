...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BLP0[0x4];                                   // 0x056C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_KillYourself_ObjectivePROXY();
		...
		void Obj_DestroyCamera_ObjectivePROXY_1();
