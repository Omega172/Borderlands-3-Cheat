...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_8B19[0x4];                                   // 0x0694(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JUMK[0x4];                                   // 0x06AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SV0J[0x4];                                   // 0x06C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ME_Playerseesdefensesgodead(class UObject* Context);
		void ME_PlayeSeesFrontrunner(class UObject* Context);
		void ME_Playerdefeatstheinhibitorcarryingmechs(class UObject* Context);
		void ME_PlayerDefeatsWave3(class UObject* Context);
		void ME_Playerentersthebossarena(class UObject* Context);
		void ME_PlayerdefeatsNegativeZero(class UObject* Context);
		...
		void ME_Playerreactivatesthefirstcannons(class UObject* Context);
		void ME_Playerreactivatesthefinalcannons(class UObject* Context);
		...
		void ME_PlayertakesthekeyfragmentfromRhys(class UObject* Context);
		...
		void ME_PlayerarrivesatthebigAtlasreveal(class UObject* Context);
