...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_WMHG[0x20];                                  // 0x0530(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_29BE[0x2];                                   // 0x05CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1T57[0x13];                                  // 0x05E9(0x0013) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_N9LR[0x2];                                   // 0x05FE(0x0002) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_668R[0x10];                                  // 0x0890(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
