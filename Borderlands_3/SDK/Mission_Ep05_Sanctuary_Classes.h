...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_31MK[0x7];                                   // 0x06F9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FH12[0x7];                                   // 0x0759(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R8L4[0x7];                                   // 0x0779(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OBJ_OpenCargoBayDoor_ObjectivePROXY();
		...
		void SetanObjectiveintheDetails_5();
		...
		void OBJ_Hidden_SpawnMoxxieParty_ObjectivePROXY_6();
		void OBJ_Hidden_SpawnMoxxieParty_ObjectivePROXY_7();
		void OBJ_Hidden_SpawnMoxxieParty_ObjectivePROXY_8();
		void Hidden_OpenGarageRoomPlayerDoors(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Hidden_OpenGarageRoomPlayerDoors_ObjectivePROXY_9();
		...
		void OBJ_ReturnToBrdige_ObjectivePROXY_10();
		void OBJ_ReturnToBrdige_ObjectivePROXY_11();
