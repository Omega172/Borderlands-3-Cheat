...
namespace CG
{
	...
	public:
		...
		void MCEUpdateGoToFortSunshine(class UObject* Context);
		...
		void MCEUpdateGoToHistoricalLookout(class UObject* Context);
		...
		void MCEUpdateGoToLumberyard(class UObject* Context);
		...
		void MCEUpdateGoToLoadingDock(class UObject* Context);
		...
		void MCEUpdateCatchARail(class UObject* Context);
		void Set_RideTheRail_2(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void MCEUpdateRideToFortSunshine1(class UObject* Context);
		void MCEUpdateDialogEndPoint(class UObject* Context);
		...
		void MCEUpdateClearFortSunshine(class UObject* Context);
		...
		void MCEUpdateFreeDaltonFromCell(class UObject* Context);
		...
		void MCEUpdateTakeKeyFromDalton(class UObject* Context);
		...
		void MCEUpdateOpenDaltonsLootCrate(class UObject* Context);
		...
		void MCEUpdateTalkToClayMissionComplete(class UObject* Context);
		void MCEUpdateGetBackOnContainer(class UObject* Context);
		...
		void MCEUpdateRideToFortSunshine2(class UObject* Context);
		...
		void MCEUpdateClearFortSunshineCounter(class UObject* Context);
		void Set_KillTheAnointed(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void MCEUpdateKillTheAnointed(class UObject* Context);
		...
		void MCEUpdateFirehawkAttackFortEntrance(class UObject* Context);
		...
		void Obj_FollowClayRelianceSecretEntrance_ObjectivePROXY();
		void Obj_FollowClayRelianceSecretEntrance_ObjectivePROXY_1();
