...
namespace CG
{
	 ...
	 */
	void UIBPChar_DigiClone_C::GetOwnersGrenadeProjectileClass(class UClass** GrenadeProjectileClass)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function IBPChar_DigiClone.IBPChar_DigiClone_C.Get Owners Grenade Projectile Class");
		
		UIBPChar_DigiClone_C_GetOwnersGrenadeProjectileClass_Params params {};
