...
namespace CG
{
	 ...
	 */
	void UPassiveSkill_Gunner_ForceFeedback_C::CapacitationOnCausedDeath(class UDamageComponent* Damaged, const struct FCausedDeathDetails& Details)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UPassiveSkill_Gunner_ForceFeedback_C_CapacitationOnCausedDeath_Params params {};
