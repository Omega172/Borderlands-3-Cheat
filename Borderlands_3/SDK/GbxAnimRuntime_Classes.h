...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_UQFU[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool                                                       bRunOnServer : 1;                                        // 0x0041(0x0001) BIT_FIELD Edit, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		bool                                                       bRunOnClient : 1;                                        // 0x0041(0x0001) BIT_FIELD Edit, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		bool                                                       bRunIfLocalPlayer : 1;                                   // 0x0041(0x0001) BIT_FIELD Edit, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		bool                                                       bTriggerOnFirstPersonMesh : 1;                           // 0x0041(0x0001) BIT_FIELD Edit, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_4RER[0x6];                                   // 0x0042(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FIDV[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
