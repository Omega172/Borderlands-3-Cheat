...
namespace CG
{
	...
	public:
		...
		class UMissionObjective*                                   INVObj_Memory3_SeqComplete_Beginning_ObjVar;             // 0x0668(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void Obj_Memory4_ProtectIris_ObjectivePROXY();
		void Obj_Memory4_ProtectIris_ObjectivePROXY_1();
		void Obj_Memory4_ProtectIris_ObjectivePROXY_2();
		void Obj_Memory4_ProtectIris_ObjectivePROXY_3();
		...
		void Obj_Memory4_ProtectIris_ObjectivePROXY_4();
		...
		void INV_PlayerInMemory_ObjectivePROXY_5();
		...
		void INV_PlayerInMemory_ObjectivePROXY_6();
		void INV_PlayerInMemory_ObjectivePROXY_7();
		void INV_PlayerInMemory_ObjectivePROXY_8();
		void INV_PlayerInMemory_ObjectivePROXY_9();
		void INV_PlayerInMemory_ObjectivePROXY_10();
		...
		void INVObj_Memory3_SeqComplete_Beginning(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		...
		void INV_PlayerInMemory_ObjectivePROXY_11();
		void INV_PlayerInMemory_ObjectivePROXY_12();
		void INV_Obj_TalkToIrisLastTime_ReadyToAgreeAndDespawn(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void INV_PlayerInMemory_ObjectivePROXY_13();
		...
		void Obj_Memory4_ProtectIris_ObjectivePROXY_14();
		void Memory1A_SeqComplete(class UObject* Context);
		void INV_PlayerInMemory_ObjectivePROXY_15();
		...
		void INV_PlayerInMemory_ObjectivePROXY_16();
		...
		void Obj_Memory4_ProtectIris_ObjectivePROXY_17();
		void Obj_Memory4_ProtectIris_ObjectivePROXY_18();
