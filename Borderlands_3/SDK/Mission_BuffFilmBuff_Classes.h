...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_VHOJ[0x4];                                   // 0x063C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_COVVideo_Inv_ObjectivePROXY();
		void Obj_COVVideo_Inv_ObjectivePROXY_1();
		void Obj_COVVideo_Inv_ObjectivePROXY_2();
		...
		void Obj_COVVideo_Inv_ObjectivePROXY_3();
		void Obj_SearchTrash_ObjectivePROXY_4();
		void Obj_SearchTrashPiles_Counter_ObjectivePROXY_5();
		void Obj_Trash1_ObjectivePROXY_6();
		void Obj_Trash2_ObjectivePROXY_7();
		void Obj_Trash3_ObjectivePROXY_8();
		...
		void Obj_BuffCampDoor_ObjectivePROXY_9();
		...
		void Obj_TakeLightBulb_ObjectivePROXY_10();
		...
		void Obj_AttachHardDrive_ObjectivePROXY_11();
		void Obj_AttachHardDrive_ObjectivePROXY_12();
		void Obj_AttachHardDrive_ObjectivePROXY_13();
