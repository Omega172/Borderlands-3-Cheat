...
namespace CG
{
	 ...
	 */
	void UBP_HYP_Shield_AmpDamage_C::WeaponPutDown(class AWeapon* Weapon)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HYP_Shield_AmpDamage.BP_HYP_Shield_AmpDamage_C.Weapon Put Down");
		
		UBP_HYP_Shield_AmpDamage_C_WeaponPutDown_Params params {};
