...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_OV3B[0x4];                                   // 0x024C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FDataTableValueHandle                               DamagePerRank;                                           // 0x0250(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
