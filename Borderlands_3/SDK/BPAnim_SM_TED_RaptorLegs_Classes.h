...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_S5OY[0x8];                                   // 0x0AE8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_Q2IC[0x8];                                   // 0x1638(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
