...
namespace CG
{
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UALI_SM_BlastRequests_C::INV_Obj_ReadyToRespawn_ObjectivePROXY()
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UALI_SM_BlastRequests_C_INV_Obj_ReadyToRespawn_ObjectivePROXY_Params params {};
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UALI_SM_BlastRequests_C::INV_Obj_Respawned_ObjectivePROXY_1()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ALI_SM_BlastRequests.ALI_SM_BlastRequests_C.[INV_Obj_Respawned_Objective] PROXY_1");
		
		UALI_SM_BlastRequests_C_INV_Obj_Respawned_ObjectivePROXY_1_Params params {};
