...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_NVLP[0x8];                                   // 0x0AE8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_6OAY[0x8];                                   // 0x4EA8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JY7H[0x2];                                   // 0x55CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
