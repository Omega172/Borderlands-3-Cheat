...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_LZ9J[0x8];                                   // 0x2478(0x0008) Fix Super Size
		...
		class UStaticMeshComponent*                                BubbleShieldMesh;                                        // 0x24C8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_7YK9[0x3];                                   // 0x2525(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9A4C[0x3];                                   // 0x2535(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0784[0x3];                                   // 0x2555(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_97CT[0x7];                                   // 0x2571(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MS29[0x3];                                   // 0x25C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FStatusEffectInstanceReference                      BubbleShieldDamageTakenEffect;                           // 0x25C8(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, ContainsInstancedReference
		...
		unsigned char                                              UnknownData_NBAD[0x2];                                   // 0x2606(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JFUU[0x4];                                   // 0x2684(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_14EX[0x3];                                   // 0x26D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8LQA[0x4];                                   // 0x26DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
