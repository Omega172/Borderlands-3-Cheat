...
namespace CG
{
	...
	public:
		...
		class UMissionObjectiveSet*                                Set_KillCoVWave2_ObjSetVar;                              // 0x0530(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		class UMissionObjectiveSet*                                Set_KillCoVWave1_ObjSetVar;                              // 0x05C0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_KillCoVWave1_INVS_ObjVar;                            // 0x05C8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UMissionObjective*                                   Obj_KillCoVWave2_INVS_ObjVar;                            // 0x05D0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void Obj_LocateUgThak_ObjectivePROXY();
		void Obj_LocateUgThak_ObjectivePROXY_1();
		...
		void Set_KillCoVWave1(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_KillCoVWave1_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_KillCoVWave1(class UObject* Context);
		void Obj_KillCoV_ObjectivePROXY_2();
		void Obj_KillCoVWave2_INVS(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void UPDATE_KillCoVWave2(class UObject* Context);
		...
		void Set_KillCoVWave2(EMissionObjectiveSetEvent ObjectiveSetEvent);
