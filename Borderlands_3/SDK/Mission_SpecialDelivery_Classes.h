...
namespace CG
{
	...
	public:
		...
		void MCEUpdateKillTyreenCampCounter(class UObject* Context);
		...
		void MCEUpdateKillTroyCampCounter(class UObject* Context);
		void MCEUpdateCraneCounter(class UObject* Context);
		void Obj_InvisibleCraneCounter(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void MCEUpdateEscortThePayload(class UObject* Context);
		...
		void MCEUpdateGoToTroyCamp(class UObject* Context);
		...
		void MCEUpdateGoToTyreenCamp(class UObject* Context);
		void MCEUpdateSpecialDeliveryComplete(class UObject* Context);
		...
		void MCEUpdateKillTroyLoyalists(class UObject* Context);
		...
		void MCEUpdateDropTheLoad(class UObject* Context);
		...
		void MCEUpdateKillTyreenLoyalists(class UObject* Context);
