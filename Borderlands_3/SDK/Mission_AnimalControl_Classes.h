...
namespace CG
{
	...
	public:
		...
		void Obj_PlaceShockMeat_ObjectivePROXY_4();
		...
		void Obj_PlaceRadMeat_ObjectivePROXY_5();
		...
		void Obj_PlaceRadMeat_ObjectivePROXY_3();
		...
		void Invs_ShowBugs_ObjectivePROXY_6();
		void Invs_EatMeat_ObjectivePROXY_7();
		void Obj_PlaceShockMeat_ObjectivePROXY_2();
		void Set_PlaceGrogMeat(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_GetShockMeat_ObjectivePROXY_1();
		...
		void Obj_PlaceGrogMeat_ObjectivePROXY_8();
		void Obj_PlaceGrogMeat_ObjectivePROXY_9();
