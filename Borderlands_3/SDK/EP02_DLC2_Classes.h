...
namespace CG
{
	...
	public:
		...
		void Obj_ReachHeartsDesire_ObjectivePROXY_1();
		...
		void Obj_ReachHeartsDesire_ObjectivePROXY_2();
		void SET_KillKrichesCellar(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void Obj_ReachHeartsDesire_ObjectivePROXY_3();
		...
		void Obj_ReachHeartsDesire_ObjectivePROXY();
		...
		void Obj_ReachHeartsDesire_ObjectivePROXY_4();
		...
		void Obj_ReachHeartsDesire_ObjectivePROXY_5();
		...
		void Obj_TalkToWainwright_ObjectivePROXY_6();
