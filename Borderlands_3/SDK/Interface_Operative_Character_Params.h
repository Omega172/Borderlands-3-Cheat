...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CJIY[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UInterface_Operative_Character_C_GetMaterialsTPGun_Params
	{
	public:
	 ...
	 */
	struct UInterface_Operative_Character_C_GetMaterialsFPGun_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
	 ...
	 */
	struct UInterface_Operative_Character_C_GetMaterialsSkeletalMesh_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
	 ...
	 */
	struct UInterface_Operative_Character_C_GetMaterialsLegs_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
	 ...
	 */
	struct UInterface_Operative_Character_C_GetMaterialsArms_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
	 ...
	 */
	struct UInterface_Operative_Character_C_GetMaterialsHead_Params
	{
	public:
		TArray<class UMaterialInterface*>                          Materials;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor)
	};
	 ...
	 */
	struct UInterface_Operative_Character_C_GetSkeletalMesh_Params
	{
	public:
	 ...
	 */
	struct UInterface_Operative_Character_C_GetSkeletalMeshLegs_Params
	{
	public:
	 ...
	 */
	struct UInterface_Operative_Character_C_GetSkeletalMeshArms_Params
	{
	public:
	 ...
	 */
	struct UInterface_Operative_Character_C_GetSkeletalMeshHead_Params
	{
	public:
