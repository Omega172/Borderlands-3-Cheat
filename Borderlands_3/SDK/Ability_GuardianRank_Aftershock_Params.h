...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_74EY[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct UAbility_GuardianRank_Aftershock_C_OnDamageCaused_Params
	{
	public:
		...
		unsigned char                                              UnknownData_LE18[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_B4LG[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
