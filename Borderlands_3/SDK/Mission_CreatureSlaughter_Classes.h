...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5XXN[0x4];                                   // 0x0534(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FDialogConversation                                 TorgueVOSlaughterStart;                                  // 0x0618(0x000C) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
		bool                                                       PlayerUsedButtonCS;                                      // 0x0624(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
