...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_G9T9[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PXH5[0x3];                                   // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JCVA[0x5];                                   // 0x004B(0x0005) MISSED OFFSET (PADDING)
	};
