...
namespace CG
{
	 ...
	 */
	struct ULightProjectile_FalconStrike_ModHoming_C_OnExplode_Params
	{
	public:
	 ...
	 */
	struct ULightProjectile_FalconStrike_ModHoming_C_HomeToTarget03_Params
	{
	public:
	 ...
	 */
	struct ULightProjectile_FalconStrike_ModHoming_C_HomeToTarget02_Params
	{
	public:
		class UOakLightProjectile*                                 Projectile;                                              // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct ULightProjectile_FalconStrike_ModHoming_C_HomeToTarget_Params
	{
	public:
		class UOakLightProjectile*                                 Projectile;                                              // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
