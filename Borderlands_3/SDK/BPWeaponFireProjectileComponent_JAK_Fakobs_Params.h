...
namespace CG
{
	 ...
	 */
	struct UBPWeaponFireProjectileComponent_JAK_Fakobs_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function BPWeaponFireProjectileComponent_JAK_Fakobs.BPWeaponFireProjectileComponent_JAK_Fakobs_C.UsedWeapon
	 */
	struct UBPWeaponFireProjectileComponent_JAK_Fakobs_C_UsedWeapon_Params
	{
	public:
	 ...
	 */
	struct UBPWeaponFireProjectileComponent_JAK_Fakobs_C_ExecuteUbergraph_BPWeaponFireProjectileComponent_JAK_Fakobs_Params
	{
	public:
