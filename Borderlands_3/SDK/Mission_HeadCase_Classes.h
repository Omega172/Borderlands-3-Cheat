...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BDCW[0x7];                                   // 0x0579(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RBC0[0x3];                                   // 0x05B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_EnterVRWorld_ObjectivePROXY_2();
		...
		void Obj_CollectMemoryFragments_ObjectivePROXY_3();
		void Obj_CollectMemoryFragments_ObjectivePROXY_4();
		...
		void Obj_MemFrag1_ObjectivePROXY_5();
		void Obj_MemFrag3_ObjectivePROXY_6();
		void Obj_MemFrag2_ObjectivePROXY_7();
		void Obj_MemFrag4_ObjectivePROXY_8();
		void Obj_MemFrag1_ObjectivePROXY_9();
		void Obj_MemFrag3_ObjectivePROXY_10();
		void Obj_MemFrag2_ObjectivePROXY_11();
		void Obj_MemFrag4_ObjectivePROXY_12();
		...
		void MissionKickoff();
		void Obj_EnterVRWorld_ObjectivePROXY_1();
		...
		void Obj_EnterVRWorld_ObjectivePROXY();
