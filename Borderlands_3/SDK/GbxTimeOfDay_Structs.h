...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_AIIW[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_APQI[0x28];                                  // 0x0010(0x0028) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_PVPU[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_SK31[0x10];                                  // 0x01C8(0x0010) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_6YOB[0x8];                                   // 0x0010(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_RU10[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRichCurve                                          ValueCurve;                                              // 0x0020(0x0070) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_UJ26[0x8];                                   // 0x0090(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_DB8D[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRichCurve                                          ValueCurve[0x4];                                         // 0x0020(0x01C0) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_JNMS[0x10];                                  // 0x01E0(0x0010) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_ZBWJ[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRichCurve                                          ValueCurve[0x4];                                         // 0x0020(0x01C0) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_3JTL[0x8];                                   // 0x01E0(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_N8BF[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRichCurve                                          ValueCurve[0x4];                                         // 0x0020(0x01C0) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_OIZZ[0x10];                                  // 0x01E0(0x0010) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_HA9W[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5LIY[0x17];                                  // 0x0011(0x0017) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_93XD[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S116[0x80];                                  // 0x0020(0x0080) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_N2GB[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
