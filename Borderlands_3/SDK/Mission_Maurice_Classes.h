...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_OVS1[0x4];                                   // 0x051C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_Gift1_ObjectivePROXY();
		void Obj_Gift2_ObjectivePROXY_1();
		void Obj_Gift3_ObjectivePROXY_2();
		void MCE_RefreshObjectives(class UObject* Context);
		void Obj_Gift1_ObjectivePROXY_3();
		void Obj_Gift2_ObjectivePROXY_4();
		void Obj_Gift3_ObjectivePROXY_5();
