...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_6FD0[0x4];                                   // 0x056C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_GetSkagSpine_ObjectivePROXY();
		void Obj_UseCoVSpine_ObjectivePROXY_1();
		void Obj_GetCoVSpine_ObjectivePROXY_2();
		void Obj_UseSkagSpine_ObjectivePROXY_3();
		...
		void Obj_GetSkagSpine_ObjectivePROXY_4();
		...
		void Obj_UseSkagSpine_ObjectivePROXY_5();
		...
		void Obj_GetSkagSpine_ObjectivePROXY_6();
