...
namespace CG
{
	...
	public:
		...
		struct FStatusEffectInstanceReference                      BubbleShieldDamageTakenEffect;                           // 0x2678(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, ContainsInstancedReference
		...
		unsigned char                                              UnknownData_N45B[0x2];                                   // 0x2692(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K6X4[0x3];                                   // 0x2699(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XOBY[0x7];                                   // 0x26A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void TestHardpoint(class UOakActionAbilityAugmentData* HardPoint, bool* res);
		void SetBlackboard_Aggro(bool Toggle);
		void SetupHardpointBlackboard(class UOakActionAbilityAugmentSlotData* HardPointSlot, class UClass** res);
