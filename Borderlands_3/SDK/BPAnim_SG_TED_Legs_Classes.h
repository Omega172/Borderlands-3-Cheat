...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_WFQP[0x8];                                   // 0x0AE8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_QNQ4[0x8];                                   // 0x12B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class ABPChar_TedioreTurret_C*                             BaseBPChar;                                              // 0x1788(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
