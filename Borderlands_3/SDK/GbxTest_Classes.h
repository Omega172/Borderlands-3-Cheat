...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CEAE[0x2];                                   // 0x004E(0x0002) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZGB8[0x6];                                   // 0x008A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KUCR[0x2];                                   // 0x00EA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_TPQF[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_K217[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_4YKF[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RI1M[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0GKB[0x80];                                  // 0x0028(0x0080) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QU30[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J3ED[0x47];                                  // 0x0069(0x0047) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PCE7[0x90];                                  // 0x00B0(0x0090) MISSED OFFSET (PADDING)
