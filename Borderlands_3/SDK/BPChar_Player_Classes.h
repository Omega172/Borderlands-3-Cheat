...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UBB7[0xF];                                   // 0x3461(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		float                                                      MultikillCount;                                          // 0x356C(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_S0U7[0x3];                                   // 0x35CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void MultikillReset();
		void Player_LevelUp(int32_t OldXPLevel, int32_t NewXPLevel);
