...
namespace CG
{
	 ...
	 * Parameters:
	 * 		class UClass*                                      GrenadeProjectileClass                                     (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABPChar_DigiClone_Base_C::GetOwnersGrenadeProjectileClass(class UClass** GrenadeProjectileClass)
	{
		...
		ABPChar_DigiClone_Base_C_GetOwnersGrenadeProjectileClass_Params params {};
	 ...
	 * Parameters:
	 * 		bool                                               Provokeequiped                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void ABPChar_DigiClone_Base_C::TryConfigureProvoke(bool* Provokeequiped)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		if (Provokeequiped != nullptr)
			*Provokeequiped = params.Provokeequiped;
	}
	 ...
	 */
	void ABPChar_DigiClone_Base_C::AutomagicallyDealBonusDamage(class AActor* Actor, class UClass* DamageSource, float Damage)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BPChar_DigiClone_Base.BPChar_DigiClone_Base_C.Automagically Deal Bonus Damage");
		
		ABPChar_DigiClone_Base_C_AutomagicallyDealBonusDamage_Params params {};
		params.Actor = Actor;
