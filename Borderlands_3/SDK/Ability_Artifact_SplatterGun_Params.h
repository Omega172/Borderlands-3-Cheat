...
namespace CG
{
	 ...
	 */
	struct UAbility_Artifact_SplatterGun_C_AmmoReturn_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_AJ7K[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
