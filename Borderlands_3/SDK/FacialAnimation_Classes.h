...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_E2WI[0x8];                                   // 0x06E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KJNH[0x2C];                                  // 0x06F4(0x002C) MISSED OFFSET (PADDING)
