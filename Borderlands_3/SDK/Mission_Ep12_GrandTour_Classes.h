...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_P3AT[0x4];                                   // 0x070C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void MCE_Playerbuzzesinattheestate(class UObject* Context);
		void Update_PlayersInParlor(class UObject* Context);
		void MCE_Playerarrivesinthetheater(class UObject* Context);
		void MCE_Playerarrivesinthetheatercontrolbooth(class UObject* Context);
		void MCE_Playeropensthetrapdoor(class UObject* Context);
		void MCE_Playerhasenteredthesecretroom(class UObject* Context);
		void MCE_Playerhasfoundthesecretitem(class UObject* Context);
		void Set_TroyTitleCard(EMissionObjectiveSetEvent ObjectiveSetEvent);
		void MCE_TriggerHeadtotheaterobjective(class UObject* Context);
		...
		void Obj_HeadToEstate_ObjectivePROXY();
		...
		void Obj_HeadToEstate_ObjectivePROXY_1();
		...
		void Obj_FindItem_ObjectivePROXY_2();
		void Obj_FindItem_ObjectivePROXY_3();
		void Obj_FindItem_ObjectivePROXY_4();
		void Obj_FindItem_ObjectivePROXY_5();
		void Obj_FindItem_ObjectivePROXY_6();
		void Obj_FindItem_ObjectivePROXY_7();
		void Obj_FindItem_ObjectivePROXY_8();
		void Obj_FindItem_ObjectivePROXY_9();
		void Obj_FindItem_ObjectivePROXY_10();
		void Obj_FindItem_ObjectivePROXY_11();
		void Obj_FindItem_ObjectivePROXY_12();
		void Obj_FindItem_ObjectivePROXY_13();
		void Obj_FindItem_ObjectivePROXY_14();
		void Obj_FindItem_ObjectivePROXY_15();
