...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XD68[0x4];                                   // 0x061C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VKY2[0x7];                                   // 0x0641(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OBJ_CollectMedicine_ObjectivePROXY();
		void OBJ_CollectMedicine_Blood_ObjectivePROXY_1();
		void OBJ_CollectMedicine_ObjectivePROXY_2();
		void OBJ_CollectMedicine_Blood_ObjectivePROXY_3();
		...
		void OBJ_CollectMedicine_ObjectivePROXY_4();
		void OBJ_CollectMedicine_Blood_ObjectivePROXY_5();
		...
		void Obj_MedChestCLocation_ObjectivePROXY_6();
		void Obj_MedChestBLocation_ObjectivePROXY_7();
		void Obj_MedChestBLocation_ObjectivePROXY_8();
		void Obj_MedChestCLocation_ObjectivePROXY_9();
		void Obj_MedChestBLocation_ObjectivePROXY_10();
		void Obj_MedChestCLocation_ObjectivePROXY_11();
		void Obj_MedChestC_ObjectivePROXY_12();
		void Obj_MedChestC_ObjectivePROXY_13();
		void Obj_MedChestC_ObjectivePROXY_14();
		void OBJ_AllSuppliesFound(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void OBJ_AllSuppliesFound_ObjectivePROXY_15();
		void OBJ_AllSuppliesFound_ObjectivePROXY_16();
		void OBJ_AllSuppliesFound_ObjectivePROXY_17();
