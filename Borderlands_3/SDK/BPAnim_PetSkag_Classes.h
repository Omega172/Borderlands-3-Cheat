...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_UVV9[0x8];                                   // 0x0AE8(0x0008) Fix Super Size
		...
		class UPawnMovementComponent*                              MovementComponent;                                       // 0x4648(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		float                                                      RightArm;                                                // 0x4654(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		float                                                      LeftArm;                                                 // 0x465C(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_INHB[0x3];                                   // 0x4675(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       HasFallAnims;                                            // 0x467C(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
