...
namespace CG
{
	 ...
	 */
	struct UPassiveSkill_Operative_CoolerHeads_C_ExperimentalBulletsonCritialHit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_DAL5[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
