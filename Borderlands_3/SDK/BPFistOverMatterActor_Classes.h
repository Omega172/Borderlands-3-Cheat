...
namespace CG
{
	...
	public:
		...
		struct FDataTableValueHandle                               WebSphereRadius;                                         // 0x0498(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		struct FDataTableValueHandle                               WebDuration;                                             // 0x04B0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		...
		unsigned char                                              UnknownData_UL4L[0x4];                                   // 0x04E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0ZPA[0x4];                                   // 0x04FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
