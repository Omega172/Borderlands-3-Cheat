...
namespace CG
{
	 ...
	 */
	void UOakAbility_Beastmaster_ClassMod_DLC1_C::BeastmasterDLC1ClassModOnCausedAnyDamage(class AActor* DamageInstigator, float Damage, class UGbxDamageType* DamageType, class UDamageSource* DamageSource, class AActor* DamagedActor, const struct FCausedDamageDetails& Details)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UOakAbility_Beastmaster_ClassMod_DLC1_C_BeastmasterDLC1ClassModOnCausedAnyDamage_Params params {};
