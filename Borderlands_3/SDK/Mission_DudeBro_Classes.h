...
namespace CG
{
	...
	public:
		...
		void MCEPlayerHasCompletedJump(class UObject* Context);
		...
		void MCEChaddSaysRandomJumpLine(class UObject* Context);
		void MCEKillGrog(class UObject* Context);
		void MCEChaddReadToJump(class UObject* Context);
		...
		void MCEUseRocketPart2(class UObject* Context);
		void MCEUseRocketPart3(class UObject* Context);
		...
		void MCEWatchChaddBaseJump(class UObject* Context);
		void Obj_PlayerBaseJumpPrep(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void MCEAnswerCallTalkToChadd(class UObject* Context);
		...
		void MCEGiveGutsToChadd(class UObject* Context);
		void MCEFollowChaddSaurianFight(class UObject* Context);
		...
		void MCEReviveChaddJump(class UObject* Context);
		void MCEFollowChaddBaseJump(class UObject* Context);
		void MCEFollowChaddGrogFight(class UObject* Context);
		...
		void MCEReviveChaddFight(class UObject* Context);
		void MCEGotChaddLootMissionComplete(class UObject* Context);
		...
		void MCEShootTheIgniter(class UObject* Context);
		void MCEUseRocketPart1(class UObject* Context);
		...
		void Obj_ReviveChaddJump_ObjectivePROXY();
		void Obj_FuelCanCounter_ObjectivePROXY_1();
		void MissionKickoff();
