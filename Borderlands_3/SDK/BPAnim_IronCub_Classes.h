...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_S9M9[0x8];                                   // 0x11A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7AL5[0x8];                                   // 0x1DE8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EU82[0x8];                                   // 0x2498(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
