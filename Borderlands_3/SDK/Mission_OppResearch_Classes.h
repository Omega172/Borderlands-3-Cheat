...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_T7WO[0x4];                                   // 0x058C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A5VL[0x4];                                   // 0x067C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_GetKDirt_ObjectivePROXY_2();
		...
		void Obj_GetKDirt_ObjectivePROXY_3();
		...
		void Obj_GetKDirt_ObjectivePROXY_4();
