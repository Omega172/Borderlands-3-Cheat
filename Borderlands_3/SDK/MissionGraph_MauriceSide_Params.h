...
namespace CG
{
	 ...
	 */
	struct UMissionGraph_MauriceSide_C_SaurianNotSaurian_Params
	{
	public:
		unsigned char                                              UnknownData_6RJL[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_0GE5[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
