...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_A83H[0x7];                                   // 0x0539(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QWWQ[0x4];                                   // 0x05AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_HarvestLivers_ObjectivePROXY();
		...
		void Obj_FloodRatch_ObjectivePROXY_1();
		void Obj_KillBirthers_ObjectivePROXY_2();
		void Obj_OpenBarrel02_ObjectivePROXY_3();
		void Obj_OpenBarrel03_ObjectivePROXY_4();
