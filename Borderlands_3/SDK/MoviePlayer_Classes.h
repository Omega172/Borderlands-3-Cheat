...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1UIO[0x6];                                   // 0x002A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SF1A[0x7];                                   // 0x0041(0x0007) MISSED OFFSET (PADDING)
