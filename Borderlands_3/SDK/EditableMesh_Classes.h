...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_WW1M[0xD50];                                 // 0x0028(0x0D50) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WBCF[0xF8];                                  // 0x0D8C(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WCEK[0x1E4];                                 // 0x0E8C(0x01E4) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7SFY[0xA4];                                  // 0x003C(0x00A4) MISSED OFFSET (PADDING)
