...
namespace CG
{
	 ...
	 * 		bool                                               DontAdjust                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	float UActionSkill_Siren_Phasetrance_C::CalculateLeechHealAmount(float Damage, bool DontAdjust)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UActionSkill_Siren_Phasetrance_C_CalculateLeechHealAmount_Params params {};
		params.Damage = Damage;
		params.DontAdjust = DontAdjust;
