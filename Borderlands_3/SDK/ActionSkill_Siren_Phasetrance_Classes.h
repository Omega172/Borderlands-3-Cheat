...
namespace CG
{
	...
	public:
		...
		bool                                                       WebMissed;                                               // 0x0310(0x0001) Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_8TT2[0x7];                                   // 0x0311(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void StartAttack();
		float CalculateLeechHealAmount(float Damage, bool DontAdjust);
