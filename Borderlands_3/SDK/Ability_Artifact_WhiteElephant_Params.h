...
namespace CG
{
	 ...
	 */
	struct UAbility_Artifact_WhiteElephant_C_AmmoReturn_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_A056[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
