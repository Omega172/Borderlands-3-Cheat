...
namespace CG
{
	 ...
	 * 		float                                              BiasedLevel                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UBP_LootRarityFunctionLibrary_C::STATIC_ApplyRarityWeightLevelBias(float LevelToDetermineRarityAt, float GlobalRarityWeightLevelBias, float LocalRarityWeightLevelBias, float RarityWeightLevelBiasMultiplier, class UObject* __WorldContext, float* BiasedLevel)
	{
		...
		if (BiasedLevel != nullptr)
			*BiasedLevel = params.BiasedLevel;
	}
