...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_MWBK[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Y648[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_J2JQ[0x40];                                  // 0x0048(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_V4RD[0xF];                                   // 0x0099(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P811[0x30];                                  // 0x00B0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VCAI[0xD0];                                  // 0x00E8(0x00D0) MISSED OFFSET (PADDING)
