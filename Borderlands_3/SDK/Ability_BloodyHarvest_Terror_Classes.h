...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MRRX[0x4];                                   // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void GetTerrorResourcePoolValues(bool* IsValid, float* TerrorCurrentValue);
		void RemoveTerror();
		...
		void ApplyTerror();
		void Terror();
		void UpdateTerror(const struct FGameResourcePoolReference& ResourcePool);
