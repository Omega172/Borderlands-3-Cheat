...
namespace CG
{
	 ...
	 */
	struct UCE_PlayerShared_Skills_Confuse_C_OnConfuseTargetdeath_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_9Z23[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_K50S[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
