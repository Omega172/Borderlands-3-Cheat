...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_LQ3A[0x8];                                   // 0x0AE8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_9QC4[0x8];                                   // 0x1278(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K0S2[0x8];                                   // 0x46A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TW2O[0x3];                                   // 0x9C61(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8RQK[0x1];                                   // 0x9C6F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       HasFallAnims;                                            // 0x9C88(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		...
		unsigned char                                              UnknownData_V8HF[0x3];                                   // 0x9C8D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0E8A[0x7];                                   // 0x9C99(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void CalculateWeaponHoldData(class AWeapon* NewWeapon, bool* ValidWeapon);
