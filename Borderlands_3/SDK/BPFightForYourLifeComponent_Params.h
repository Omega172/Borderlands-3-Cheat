...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UCSO[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct UBPFightForYourLifeComponent_C_ReplenishAssaultRifleAmmoToSetPercentage_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_QJIV[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
