...
namespace CG
{
	...
	public:
		...
		void OBJ_FindGang_ObjectivePROXY();
		void OBJ_FindGang_ObjectivePROXY_1();
		void OBJ_FindGang_ObjectivePROXY_2();
		void OBJ_FindGang_ObjectivePROXY_3();
		void OBJ_FindGang_ObjectivePROXY_4();
		void OBJ_FindGang_ObjectivePROXY_5();
		void OBJ_FindGang_ObjectivePROXY_6();
		void OBJ_FindGang_ObjectivePROXY_7();
		void OBJ_FindGang_ObjectivePROXY_8();
		void OBJ_FindGang_ObjectivePROXY_9();
		void OBJ_FindGang_ObjectivePROXY_10();
		void OBJ_FindGang_ObjectivePROXY_11();
