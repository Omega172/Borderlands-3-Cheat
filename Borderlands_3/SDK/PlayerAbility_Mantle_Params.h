...
namespace CG
{
	 ...
	 */
	struct UPlayerAbility_Mantle_C_GbxInpActEvt_InputAction_Discrete_Mantle_K2Node_GbxInputActionEvent_Discrete_4_Params
	{
	public:
	 ...
	 */
	struct UPlayerAbility_Mantle_C_GbxInpActEvt_InputAction_Discrete_Mantle_K2Node_GbxInputActionEvent_Discrete_3_Params
	{
	public:
		class UGbxInputActionData_Discrete*                        Action;                                                  // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct UPlayerAbility_Mantle_C_OnPaused_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_1LFX[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
