...
namespace CG
{
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		class UClass*                                      DataBlueprint                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 ...
	 */
	void UBPWeaponFireProjectile_TheNothing_C::FireProjectiles(class UClass* DataBlueprint, int32_t SampleCount)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		params.DataBlueprint = DataBlueprint;
