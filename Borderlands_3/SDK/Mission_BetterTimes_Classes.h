...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RXUX[0x4];                                   // 0x05D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_GetEchoLogs_ObjectivePROXY();
		void Obj_GetEchoLogs_ObjectivePROXY_1();
		void Obj_GetEchoLogs_ObjectivePROXY_2();
		...
		void Obj_GetEchoLogs_ObjectivePROXY_3();
