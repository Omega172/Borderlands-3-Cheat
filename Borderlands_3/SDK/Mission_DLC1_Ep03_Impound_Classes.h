...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RJON[0x4];                                   // 0x07E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Obj_TalkToDataRequisition_ObjectivePROXY();
		...
		void Obj_AttackBot_ObjectivePROXY_1();
		...
		void Obj_GoToCustomerCareCenterFake_ObjectivePROXY_2();
		...
		void Obj_TalkToDataRequisition_ObjectivePROXY_3();
		...
		void Obj_GoToCustomerCare_WrongForm_ObjectivePROXY_4();
		...
		void Obj_TalkToDataRequisition_Again_ObjectivePROXY_5();
		...
		void Obj_TalkToClientServicesAgain_ObjectivePROXY_6();
		void Obj_InsertForm(EMissionObjectiveEvent ObjectiveEvent, int32_t ObjectiveCount);
		void Obj_GoToCustomerCare_Real_ObjectivePROXY_7();
		...
		void Obj_GetNewNumber_Precise_ObjectivePROXY_8();
		...
		void Obj_GoToCustomerCare_Real_ObjectivePROXY_9();
		...
		void Obj_FindShip_ObjectivePROXY_10();
		...
		void Obj_GoToCustomerCare_Real_ObjectivePROXY_11();
		...
		void Obj_FindEddiesFriend_ObjectivePROXY_12();
		void Obj_FindEddiesFriend_BC1_ObjectivePROXY_13();
		void Obj_FindEddiesFriend_ObjectivePROXY_14();
		...
		void Obj_GoToCustomerCareCenterFake_ObjectivePROXY_15();
		...
		void INV_Obj_PlayerWokeEnemy_ObjectivePROXY_16();
