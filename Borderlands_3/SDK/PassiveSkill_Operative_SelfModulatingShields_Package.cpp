...
namespace CG
{
	 ...
	 */
	void UPassiveSkill_Operative_SelfModulatingShields_C::RemoveStatusEffectModifier()
	{
		...
		UPassiveSkill_Operative_SelfModulatingShields_C_RemoveStatusEffectModifier_Params params {};
	 ...
	 */
	void UPassiveSkill_Operative_SelfModulatingShields_C::AddStatusEffectModifier()
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UPassiveSkill_Operative_SelfModulatingShields_C_AddStatusEffectModifier_Params params {};
	 ...
	 */
	void UPassiveSkill_Operative_SelfModulatingShields_C::SelfModulatingShieldsOnTakeAnyDamage(class UDamageComponent* DamageReceiver, float Damage, class UGbxDamageType* DamageType, class UDamageSource* DamageSource, class AController* InstigatedBy, class UDamageCauserComponent* DamageCauser, const struct FReceivedDamageDetails& Details)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		UPassiveSkill_Operative_SelfModulatingShields_C_SelfModulatingShieldsOnTakeAnyDamage_Params params {};
