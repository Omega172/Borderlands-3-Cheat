...
namespace CG
{
	 ...
	 * 		struct FVector                                     NewHomingLocation                                          (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 ...
	 */
	void AProj_Siren_DLCSkill_WalkingPotato_Base_C::SetOrbMovement(class AActor* NewHomingTarget, const struct FVector& NewHomingLocation, float ReachDistance)
	{
		static UFunction* fn = nullptr;
		if (!fn)
		...
		params.NewHomingLocation = NewHomingLocation;
