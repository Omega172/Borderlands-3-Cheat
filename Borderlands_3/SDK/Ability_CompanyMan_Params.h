...
namespace CG
{
	 ...
	 */
	struct UAbility_CompanyMan_C_StartInvesting_Params
	{	};

	/**
	 * Function Ability_CompanyMan.Ability_CompanyMan_C.Stop Investing
	 */
	struct UAbility_CompanyMan_C_StopInvesting_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_11KT[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
