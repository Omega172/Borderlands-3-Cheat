...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_VGF0[0x3];                                   // 0x2741(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnLeftLegJointDamaged(const struct FDamageReactionEventSummary& DamageEvent);
		void PetLoaderBadass_AnticipateLaserBall();
		void OnRightLegJointDamaged(const struct FDamageReactionEventSummary& DamageEvent);
		void OnLeftArmJointDamaged(const struct FDamageReactionEventSummary& DamageEvent);
		void OnRightArmJointDamaged(const struct FDamageReactionEventSummary& DamageEvent);
